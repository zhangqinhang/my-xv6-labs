...
main(int argc, char *argv[])
{
  ...
  4e:	34fd                	addiw	s1,s1,-1
    ...
    // 缓冲区存放从管道读出的数据
    char buf[MAXN] = {"\0"};
  50:	aa043023          	sd	zero,-1376(s0)
  54:	3f800613          	li	a2,1016
  58:	4581                	li	a1,0
  5a:	aa840513          	addi	a0,s0,-1368
  5e:	00000097          	auipc	ra,0x0
  62:	142080e7          	jalr	322(ra) # 1a0 <memset>
  ...
  6c:	00f70bb3          	add	s7,a4,a5
  70:	708b8c93          	addi	s9,s7,1800
        // xargs 命令的参数后面再追加参数
        argvs[index] = temp;
  74:	048e                	slli	s1,s1,0x3
  76:	00970b33          	add	s6,a4,s1
  7a:	70078793          	addi	a5,a5,1792 # fffffffffffff700 <__global_pointer$+0xffffffffffffe60f>
  7e:	00f70ab3          	add	s5,a4,a5
    while((n = read(0, buf, MAXN)) > 0 ) {
  82:	40000613          	li	a2,1024
  86:	aa040593          	addi	a1,s0,-1376
  8a:	4501                	li	a0,0
  8c:	00000097          	auipc	ra,0x0
  90:	330080e7          	jalr	816(ra) # 3bc <read>
  94:	08a05863          	blez	a0,124 <main+0x124>
		char temp[MAXN] = {"\0"};
  98:	700bb023          	sd	zero,1792(s7)
  9c:	3f800613          	li	a2,1016
  a0:	4581                	li	a1,0
  a2:	8566                	mv	a0,s9
  a4:	00000097          	auipc	ra,0x0
  a8:	0fc080e7          	jalr	252(ra) # 1a0 <memset>
        argvs[index] = temp;
  ac:	f15b3023          	sd	s5,-256(s6)
        // 内循环获取追加的参数并创建子进程执行命令
        for(int i = 0; i < strlen(buf); ++i) {
  b0:	89d6                	mv	s3,s5
  b2:	aa040913          	addi	s2,s0,-1376
  b6:	4481                	li	s1,0
            // 读取单个输入行，当遇到换行符时，创建子线程
            if(buf[i] == '\n') {
  b8:	4a29                	li	s4,10
        for(int i = 0; i < strlen(buf); ++i) {
  ba:	a825                	j	f2 <main+0xf2>
        fprintf(2, "usage: xargs command\n");
  bc:	00001597          	auipc	a1,0x1
  c0:	80458593          	addi	a1,a1,-2044 # 8c0 <malloc+0xe6>
  c4:	4509                	li	a0,2
  c6:	00000097          	auipc	ra,0x0
  ca:	628080e7          	jalr	1576(ra) # 6ee <fprintf>
        exit(1);
  ce:	4505                	li	a0,1
  d0:	00000097          	auipc	ra,0x0
  d4:	2d4080e7          	jalr	724(ra) # 3a4 <exit>
                // 创建子线程执行命令
                if (fork() == 0) {
  d8:	00000097          	auipc	ra,0x0
  dc:	2c4080e7          	jalr	708(ra) # 39c <fork>
  e0:	c90d                	beqz	a0,112 <main+0x112>
                    exec(argv[1], argvs);
                }
                // 等待子线程执行完毕
                wait(0);
  ...
  e8:	2c8080e7          	jalr	712(ra) # 3ac <wait>
        for(int i = 0; i < strlen(buf); ++i) {
  ec:	2485                	addiw	s1,s1,1
  ee:	0985                	addi	s3,s3,1
  f0:	0905                	addi	s2,s2,1
  f2:	aa040513          	addi	a0,s0,-1376
  f6:	00000097          	auipc	ra,0x0
  fa:	080080e7          	jalr	128(ra) # 176 <strlen>
  fe:	2501                	sext.w	a0,a0
 100:	f8a4f1e3          	bgeu	s1,a0,82 <main+0x82>
            if(buf[i] == '\n') {
 104:	00094783          	lbu	a5,0(s2)
 108:	fd4788e3          	beq	a5,s4,d8 <main+0xd8>
            } else {
                // 否则，读取管道的输出作为输入
                temp[i] = buf[i];
 10c:	00f98023          	sb	a5,0(s3)
 110:	bff1                	j	ec <main+0xec>
                    exec(argv[1], argvs);
 112:	ea040593          	addi	a1,s0,-352
 116:	008c3503          	ld	a0,8(s8)
 11a:	00000097          	auipc	ra,0x0
 11e:	2c2080e7          	jalr	706(ra) # 3dc <exec>
 122:	b7c1                	j	e2 <main+0xe2>
            }
        }
    }
    // 正常退出
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48c:	45850513          	addi	a0,a0,1112 # 8e0 <digits>
 490:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 558:	38cb8b93          	addi	s7,s7,908 # 8e0 <digits>
 ...
 698:	24490913          	addi	s2,s2,580 # 8d8 <malloc+0xfe>
        while(*s != 0){
...
free(void *ap)
{
 ...
 760:	19c7b783          	ld	a5,412(a5) # 8f8 <freep>
 ...
 78e:	00e6ea63          	bltu	a3,a4,7a2 <free+0x50>
{
 ...
 7d0:	12f73623          	sd	a5,300(a4) # 8f8 <freep>
}
 7d4:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 802:	0fa53503          	ld	a0,250(a0) # 8f8 <freep>
 ...
 82a:	0d290913          	addi	s2,s2,210 # 8f8 <freep>
  if(p == (char*)-1)
 82e:	5afd                	li	s5,-1
 830:	a88d                	j	8a2 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 832:	00000797          	auipc	a5,0x0
 836:	0ce78793          	addi	a5,a5,206 # 900 <base>
 83a:	00000717          	auipc	a4,0x0
 83e:	0af73f23          	sd	a5,190(a4) # 8f8 <freep>
 842:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 864:	08a73c23          	sd	a0,152(a4) # 8f8 <freep>
      return (void*)(p + 1);
