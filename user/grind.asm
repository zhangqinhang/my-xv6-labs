...
go(int which_child)
{
  ...
  int fd = -1;
      ...
      sbrk(6011);
      fc:	6a85                	lui	s5,0x1
      fe:	77ba8a93          	addi	s5,s5,1915 # 177b <buf.1239+0xeb>
    ...
    if(what == 1){
     ...
     396:	2fe58593          	addi	a1,a1,766 # 1690 <buf.1239>
     39a:	854a                	mv	a0,s2
     ...
     3ae:	2e658593          	addi	a1,a1,742 # 1690 <buf.1239>
     3b2:	854a                	mv	a0,s2
