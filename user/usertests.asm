...
00000000000011c6 <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    125e:	fbe78793          	addi	a5,a5,-66 # 8218 <big.1271>
...
0000000000002052 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ba:	06278793          	addi	a5,a5,98 # 8118 <args.1813>
    20be:	00006697          	auipc	a3,0x6
    20c2:	15268693          	addi	a3,a3,338 # 8210 <args.1813+0xf8>
    ...
    20da:	04258593          	addi	a1,a1,66 # 8118 <args.1813>
