...
00000000000011ba <copyinstr2>:
{
  ...
  if(pid == 0){
    ...
    1252:	00a78793          	addi	a5,a5,10 # 8258 <big.1271>
...
0000000000002044 <bigargtest>:
{
  ...
  close(fd);
    ...
    20ac:	0b078793          	addi	a5,a5,176 # 8158 <args.1813>
    20b0:	00006697          	auipc	a3,0x6
    20b4:	1a068693          	addi	a3,a3,416 # 8250 <args.1813+0xf8>
    ...
    20cc:	09058593          	addi	a1,a1,144 # 8158 <args.1813>
