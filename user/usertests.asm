...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	e1a50513          	addi	a0,a0,-486 # 5e58 <malloc+0x404>
      46:	00006097          	auipc	ra,0x6
      4a:	950080e7          	jalr	-1712(ra) # 5996 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	34078793          	addi	a5,a5,832 # 9398 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	a4868693          	addi	a3,a3,-1464 # baa8 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	df850513          	addi	a0,a0,-520 # 5e78 <malloc+0x424>
      88:	00006097          	auipc	ra,0x6
      8c:	90e080e7          	jalr	-1778(ra) # 5996 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	de850513          	addi	a0,a0,-536 # 5e90 <malloc+0x43c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	dea50513          	addi	a0,a0,-534 # 5eb0 <malloc+0x45c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	db250513          	addi	a0,a0,-590 # 5e98 <malloc+0x444>
      ee:	00006097          	auipc	ra,0x6
      f2:	8a8080e7          	jalr	-1880(ra) # 5996 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	dbe50513          	addi	a0,a0,-578 # 5ec0 <malloc+0x46c>
     10a:	00006097          	auipc	ra,0x6
     10e:	88c080e7          	jalr	-1908(ra) # 5996 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	dbc50513          	addi	a0,a0,-580 # 5ee8 <malloc+0x494>
     134:	00005097          	auipc	ra,0x5
     138:	532080e7          	jalr	1330(ra) # 5666 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	da850513          	addi	a0,a0,-600 # 5ee8 <malloc+0x494>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	da458593          	addi	a1,a1,-604 # 5ef8 <malloc+0x4a4>
     15c:	00005097          	auipc	ra,0x5
     160:	4da080e7          	jalr	1242(ra) # 5636 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d8050513          	addi	a0,a0,-640 # 5ee8 <malloc+0x494>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d8458593          	addi	a1,a1,-636 # 5f00 <malloc+0x4ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	d5450513          	addi	a0,a0,-684 # 5ee8 <malloc+0x494>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	d3e50513          	addi	a0,a0,-706 # 5f08 <malloc+0x4b4>
     1d2:	00005097          	auipc	ra,0x5
     1d6:	7c4080e7          	jalr	1988(ra) # 5996 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	a8c50513          	addi	a0,a0,-1396 # 5d08 <malloc+0x2b4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	a78a8a93          	addi	s5,s5,-1416 # 5d08 <malloc+0x2b4>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	810a0a13          	addi	s4,s4,-2032 # baa8 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	c1e50513          	addi	a0,a0,-994 # 5f30 <malloc+0x4dc>
     31a:	00005097          	auipc	ra,0x5
     31e:	67c080e7          	jalr	1660(ra) # 5996 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	c1a50513          	addi	a0,a0,-998 # 5f50 <malloc+0x4fc>
     33e:	00005097          	auipc	ra,0x5
     342:	658080e7          	jalr	1624(ra) # 5996 <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	bf6a0a13          	addi	s4,s4,-1034 # 5f68 <malloc+0x514>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	b5250513          	addi	a0,a0,-1198 # 5f70 <malloc+0x51c>
     426:	00005097          	auipc	ra,0x5
     42a:	570080e7          	jalr	1392(ra) # 5996 <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	b4c50513          	addi	a0,a0,-1204 # 5f88 <malloc+0x534>
     444:	00005097          	auipc	ra,0x5
     448:	552080e7          	jalr	1362(ra) # 5996 <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	b5e50513          	addi	a0,a0,-1186 # 5fb8 <malloc+0x564>
     462:	00005097          	auipc	ra,0x5
     466:	534080e7          	jalr	1332(ra) # 5996 <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	b7450513          	addi	a0,a0,-1164 # 5fe8 <malloc+0x594>
     47c:	00005097          	auipc	ra,0x5
     480:	51a080e7          	jalr	1306(ra) # 5996 <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	b6650513          	addi	a0,a0,-1178 # 5ff8 <malloc+0x5a4>
     49a:	00005097          	auipc	ra,0x5
     49e:	4fc080e7          	jalr	1276(ra) # 5996 <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	b58a0a13          	addi	s4,s4,-1192 # 6028 <malloc+0x5d4>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	a28a8a93          	addi	s5,s5,-1496 # 5f00 <malloc+0x4ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	ab250513          	addi	a0,a0,-1358 # 6030 <malloc+0x5dc>
     586:	00005097          	auipc	ra,0x5
     58a:	410080e7          	jalr	1040(ra) # 5996 <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	aac50513          	addi	a0,a0,-1364 # 6048 <malloc+0x5f4>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	3f2080e7          	jalr	1010(ra) # 5996 <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	a3250513          	addi	a0,a0,-1486 # 5fe8 <malloc+0x594>
     5be:	00005097          	auipc	ra,0x5
     5c2:	3d8080e7          	jalr	984(ra) # 5996 <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	aa850513          	addi	a0,a0,-1368 # 6078 <malloc+0x624>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	3be080e7          	jalr	958(ra) # 5996 <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	aa250513          	addi	a0,a0,-1374 # 6090 <malloc+0x63c>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	3a0080e7          	jalr	928(ra) # 5996 <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	8b458593          	addi	a1,a1,-1868 # 5ef8 <malloc+0x4a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	88850513          	addi	a0,a0,-1912 # 5ee8 <malloc+0x494>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	85c50513          	addi	a0,a0,-1956 # 5ee8 <malloc+0x494>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	84850513          	addi	a0,a0,-1976 # 5ee8 <malloc+0x494>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	a4258593          	addi	a1,a1,-1470 # 6120 <malloc+0x6cc>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	7c850513          	addi	a0,a0,1992 # 5ee8 <malloc+0x494>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	95c50513          	addi	a0,a0,-1700 # 60c0 <malloc+0x66c>
     76c:	00005097          	auipc	ra,0x5
     770:	22a080e7          	jalr	554(ra) # 5996 <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	96050513          	addi	a0,a0,-1696 # 60e0 <malloc+0x68c>
     788:	00005097          	auipc	ra,0x5
     78c:	20e080e7          	jalr	526(ra) # 5996 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	95c50513          	addi	a0,a0,-1700 # 60f0 <malloc+0x69c>
     79c:	00005097          	auipc	ra,0x5
     7a0:	1fa080e7          	jalr	506(ra) # 5996 <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	96050513          	addi	a0,a0,-1696 # 6110 <malloc+0x6bc>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	1de080e7          	jalr	478(ra) # 5996 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	92c50513          	addi	a0,a0,-1748 # 60f0 <malloc+0x69c>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	1ca080e7          	jalr	458(ra) # 5996 <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	94650513          	addi	a0,a0,-1722 # 6128 <malloc+0x6d4>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	1ac080e7          	jalr	428(ra) # 5996 <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	94850513          	addi	a0,a0,-1720 # 6148 <malloc+0x6f4>
     808:	00005097          	auipc	ra,0x5
     80c:	18e080e7          	jalr	398(ra) # 5996 <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	93450513          	addi	a0,a0,-1740 # 6168 <malloc+0x714>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	94498993          	addi	s3,s3,-1724 # 6190 <malloc+0x73c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	974a8a93          	addi	s5,s5,-1676 # 61c8 <malloc+0x774>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	8ce50513          	addi	a0,a0,-1842 # 6168 <malloc+0x714>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	1f458593          	addi	a1,a1,500 # baa8 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	89250513          	addi	a0,a0,-1902 # 6168 <malloc+0x714>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	87050513          	addi	a0,a0,-1936 # 6170 <malloc+0x71c>
     908:	00005097          	auipc	ra,0x5
     90c:	08e080e7          	jalr	142(ra) # 5996 <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	88250513          	addi	a0,a0,-1918 # 61a0 <malloc+0x74c>
     926:	00005097          	auipc	ra,0x5
     92a:	070080e7          	jalr	112(ra) # 5996 <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	89c50513          	addi	a0,a0,-1892 # 61d8 <malloc+0x784>
     944:	00005097          	auipc	ra,0x5
     948:	052080e7          	jalr	82(ra) # 5996 <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	8a850513          	addi	a0,a0,-1880 # 6200 <malloc+0x7ac>
     960:	00005097          	auipc	ra,0x5
     964:	036080e7          	jalr	54(ra) # 5996 <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	8ac50513          	addi	a0,a0,-1876 # 6220 <malloc+0x7cc>
     97c:	00005097          	auipc	ra,0x5
     980:	01a080e7          	jalr	26(ra) # 5996 <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	8a850513          	addi	a0,a0,-1880 # 6238 <malloc+0x7e4>
     998:	00005097          	auipc	ra,0x5
     99c:	ffe080e7          	jalr	-2(ra) # 5996 <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	89650513          	addi	a0,a0,-1898 # 6258 <malloc+0x804>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	0d290913          	addi	s2,s2,210 # baa8 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	84450513          	addi	a0,a0,-1980 # 6258 <malloc+0x804>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	08090913          	addi	s2,s2,128 # baa8 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	80450513          	addi	a0,a0,-2044 # 6260 <malloc+0x80c>
     a64:	00005097          	auipc	ra,0x5
     a68:	f32080e7          	jalr	-206(ra) # 5996 <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	80650513          	addi	a0,a0,-2042 # 6280 <malloc+0x82c>
     a82:	00005097          	auipc	ra,0x5
     a86:	f14080e7          	jalr	-236(ra) # 5996 <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	81250513          	addi	a0,a0,-2030 # 62a8 <malloc+0x854>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	ef8080e7          	jalr	-264(ra) # 5996 <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	79650513          	addi	a0,a0,1942 # 6258 <malloc+0x804>
     ...
     af2:	7da50513          	addi	a0,a0,2010 # 62c8 <malloc+0x874>
     af6:	00005097          	auipc	ra,0x5
     afa:	ea0080e7          	jalr	-352(ra) # 5996 <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	7e450513          	addi	a0,a0,2020 # 62f0 <malloc+0x89c>
     b14:	00005097          	auipc	ra,0x5
     b18:	e82080e7          	jalr	-382(ra) # 5996 <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	7de50513          	addi	a0,a0,2014 # 6308 <malloc+0x8b4>
     b32:	00005097          	auipc	ra,0x5
     b36:	e64080e7          	jalr	-412(ra) # 5996 <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	7ea50513          	addi	a0,a0,2026 # 6330 <malloc+0x8dc>
     b4e:	00005097          	auipc	ra,0x5
     b52:	e48080e7          	jalr	-440(ra) # 5996 <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	12450513          	addi	a0,a0,292 # 5c98 <malloc+0x244>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	7dc58593          	addi	a1,a1,2012 # 6368 <malloc+0x914>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	0f050513          	addi	a0,a0,240 # 5c98 <malloc+0x244>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	0da50513          	addi	a0,a0,218 # 5c98 <malloc+0x244>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	0c450513          	addi	a0,a0,196 # 5c98 <malloc+0x244>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	7c858593          	addi	a1,a1,1992 # 63b0 <malloc+0x95c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	ea458593          	addi	a1,a1,-348 # baa8 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	04850513          	addi	a0,a0,72 # 5c98 <malloc+0x244>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	6d850513          	addi	a0,a0,1752 # 6348 <malloc+0x8f4>
     c78:	00005097          	auipc	ra,0x5
     c7c:	d1e080e7          	jalr	-738(ra) # 5996 <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	6e450513          	addi	a0,a0,1764 # 6370 <malloc+0x91c>
     c94:	00005097          	auipc	ra,0x5
     c98:	d02080e7          	jalr	-766(ra) # 5996 <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	6e850513          	addi	a0,a0,1768 # 6390 <malloc+0x93c>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	ce6080e7          	jalr	-794(ra) # 5996 <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	6f450513          	addi	a0,a0,1780 # 63b8 <malloc+0x964>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	cca080e7          	jalr	-822(ra) # 5996 <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	6f850513          	addi	a0,a0,1784 # 63d8 <malloc+0x984>
     ce8:	00005097          	auipc	ra,0x5
     cec:	cae080e7          	jalr	-850(ra) # 5996 <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	6fc50513          	addi	a0,a0,1788 # 63f8 <malloc+0x9a4>
     d04:	00005097          	auipc	ra,0x5
     d08:	c92080e7          	jalr	-878(ra) # 5996 <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	60858593          	addi	a1,a1,1544 # 6368 <malloc+0x914>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	6a058593          	addi	a1,a1,1696 # 6420 <malloc+0x9cc>
     d88:	00005517          	auipc	a0,0x5
     d8c:	69050513          	addi	a0,a0,1680 # 6418 <malloc+0x9c4>
  ...
  unlink("lf1");
     ...
     da0:	67c50513          	addi	a0,a0,1660 # 6418 <malloc+0x9c4>
     da4:	00005097          	auipc	ra,0x5
     da8:	8c2080e7          	jalr	-1854(ra) # 5666 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00005517          	auipc	a0,0x5
     db2:	66a50513          	addi	a0,a0,1642 # 6418 <malloc+0x9c4>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	65c50513          	addi	a0,a0,1628 # 6420 <malloc+0x9cc>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	ccc58593          	addi	a1,a1,-820 # baa8 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	62458593          	addi	a1,a1,1572 # 6420 <malloc+0x9cc>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	60e50513          	addi	a0,a0,1550 # 6420 <malloc+0x9cc>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	84c080e7          	jalr	-1972(ra) # 5666 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00005597          	auipc	a1,0x5
     e26:	5f658593          	addi	a1,a1,1526 # 6418 <malloc+0x9c4>
     e2a:	00005517          	auipc	a0,0x5
     e2e:	5f650513          	addi	a0,a0,1526 # 6420 <malloc+0x9cc>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	5da58593          	addi	a1,a1,1498 # 6418 <malloc+0x9c4>
     e46:	00005517          	auipc	a0,0x5
     e4a:	6e250513          	addi	a0,a0,1762 # 6528 <malloc+0xad4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	5c050513          	addi	a0,a0,1472 # 6428 <malloc+0x9d4>
     e70:	00005097          	auipc	ra,0x5
     e74:	b26080e7          	jalr	-1242(ra) # 5996 <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	5bc50513          	addi	a0,a0,1468 # 6440 <malloc+0x9ec>
     e8c:	00005097          	auipc	ra,0x5
     e90:	b0a080e7          	jalr	-1270(ra) # 5996 <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	5b850513          	addi	a0,a0,1464 # 6458 <malloc+0xa04>
     ea8:	00005097          	auipc	ra,0x5
     eac:	aee080e7          	jalr	-1298(ra) # 5996 <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	5bc50513          	addi	a0,a0,1468 # 6478 <malloc+0xa24>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	ad2080e7          	jalr	-1326(ra) # 5996 <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	5d050513          	addi	a0,a0,1488 # 64a8 <malloc+0xa54>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	ab6080e7          	jalr	-1354(ra) # 5996 <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	5cc50513          	addi	a0,a0,1484 # 64c0 <malloc+0xa6c>
     efc:	00005097          	auipc	ra,0x5
     f00:	a9a080e7          	jalr	-1382(ra) # 5996 <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	5c850513          	addi	a0,a0,1480 # 64d8 <malloc+0xa84>
     f18:	00005097          	auipc	ra,0x5
     f1c:	a7e080e7          	jalr	-1410(ra) # 5996 <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existant succeeded! oops\n", s);
     ...
     f30:	5d450513          	addi	a0,a0,1492 # 6500 <malloc+0xaac>
     f34:	00005097          	auipc	ra,0x5
     f38:	a62080e7          	jalr	-1438(ra) # 5996 <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	5e850513          	addi	a0,a0,1512 # 6530 <malloc+0xadc>
     f50:	00005097          	auipc	ra,0x5
     f54:	a46080e7          	jalr	-1466(ra) # 5996 <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	5a2a0a13          	addi	s4,s4,1442 # 6550 <malloc+0xafc>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	55050513          	addi	a0,a0,1360 # 6550 <malloc+0xafc>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	4e850513          	addi	a0,a0,1256 # 6558 <malloc+0xb04>
    1078:	00005097          	auipc	ra,0x5
    107c:	91e080e7          	jalr	-1762(ra) # 5996 <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	4e850513          	addi	a0,a0,1256 # 6578 <malloc+0xb24>
    1098:	00005097          	auipc	ra,0x5
    109c:	8fe080e7          	jalr	-1794(ra) # 5996 <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	4ec50513          	addi	a0,a0,1260 # 6598 <malloc+0xb44>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	8e2080e7          	jalr	-1822(ra) # 5996 <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	4da98993          	addi	s3,s3,1242 # 65b8 <malloc+0xb64>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	4ae50513          	addi	a0,a0,1198 # 65c8 <malloc+0xb74>
    1122:	00005097          	auipc	ra,0x5
    1126:	874080e7          	jalr	-1932(ra) # 5996 <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	1364b483          	ld	s1,310(s1) # 8278 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x8a8>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	d0a98993          	addi	s3,s3,-758 # 5e90 <malloc+0x43c>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	58878793          	addi	a5,a5,1416 # 7798 <malloc+0x1d44>
  ...
  if(pid == 0){
    ...
    124a:	14a78793          	addi	a5,a5,330 # 8390 <big.1272>
    124e:	00008697          	auipc	a3,0x8
    1252:	14268693          	addi	a3,a3,322 # 9390 <__global_pointer$+0x918>
      big[i] = 'x';
    ...
    1268:	12078623          	sb	zero,300(a5) # 9390 <__global_pointer$+0x918>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	c1c78793          	addi	a5,a5,-996 # 7e88 <malloc+0x2434>
    ...
    1294:	c0050513          	addi	a0,a0,-1024 # 5e90 <malloc+0x43c>
    ...
    12ac:	3c850513          	addi	a0,a0,968 # 6670 <malloc+0xc1c>
    12b0:	00004097          	auipc	ra,0x4
    12b4:	6e6080e7          	jalr	1766(ra) # 5996 <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	32050513          	addi	a0,a0,800 # 65e8 <malloc+0xb94>
    12d0:	00004097          	auipc	ra,0x4
    12d4:	6c6080e7          	jalr	1734(ra) # 5996 <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	32050513          	addi	a0,a0,800 # 6608 <malloc+0xbb4>
    12f0:	00004097          	auipc	ra,0x4
    12f4:	6a6080e7          	jalr	1702(ra) # 5996 <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	31e50513          	addi	a0,a0,798 # 6628 <malloc+0xbd4>
    1312:	00004097          	auipc	ra,0x4
    1316:	684080e7          	jalr	1668(ra) # 5996 <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	32650513          	addi	a0,a0,806 # 6650 <malloc+0xbfc>
    1332:	00004097          	auipc	ra,0x4
    1336:	664080e7          	jalr	1636(ra) # 5996 <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	78c50513          	addi	a0,a0,1932 # 6ad0 <malloc+0x107c>
    134c:	00004097          	auipc	ra,0x4
    1350:	64a080e7          	jalr	1610(ra) # 5996 <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	30a50513          	addi	a0,a0,778 # 6698 <malloc+0xc44>
    1396:	00004097          	auipc	ra,0x4
    139a:	600080e7          	jalr	1536(ra) # 5996 <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	b2850513          	addi	a0,a0,-1240 # 5ee8 <malloc+0x494>
  ...
  if(pid == 0){
    ...
    13ee:	afea0a13          	addi	s4,s4,-1282 # 5ee8 <malloc+0x494>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	306a8a93          	addi	s5,s5,774 # 66f8 <malloc+0xca4>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	26650513          	addi	a0,a0,614 # 66c8 <malloc+0xc74>
    146a:	00004097          	auipc	ra,0x4
    146e:	52c080e7          	jalr	1324(ra) # 5996 <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	26250513          	addi	a0,a0,610 # 66e0 <malloc+0xc8c>
    1486:	00004097          	auipc	ra,0x4
    148a:	510080e7          	jalr	1296(ra) # 5996 <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	26c50513          	addi	a0,a0,620 # 6708 <malloc+0xcb4>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	4f2080e7          	jalr	1266(ra) # 5996 <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	a2ea0a13          	addi	s4,s4,-1490 # 5ee8 <malloc+0x494>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	266a8a93          	addi	s5,s5,614 # 6728 <malloc+0xcd4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	9dc50513          	addi	a0,a0,-1572 # 5ee8 <malloc+0x494>
  ...
  exit(xstatus);
    ...
    152e:	1b650513          	addi	a0,a0,438 # 66e0 <malloc+0xc8c>
    1532:	00004097          	auipc	ra,0x4
    1536:	464080e7          	jalr	1124(ra) # 5996 <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	1e850513          	addi	a0,a0,488 # 6730 <malloc+0xcdc>
    1550:	00004097          	auipc	ra,0x4
    1554:	446080e7          	jalr	1094(ra) # 5996 <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	92078793          	addi	a5,a5,-1760 # 5e90 <malloc+0x43c>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	1d478793          	addi	a5,a5,468 # 6750 <malloc+0xcfc>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	1cc50513          	addi	a0,a0,460 # 6758 <malloc+0xd04>
  ...
  if(pid == 0) {
    ...
    15be:	19e50513          	addi	a0,a0,414 # 6758 <malloc+0xd04>
    ...
    15da:	1a250513          	addi	a0,a0,418 # 6778 <malloc+0xd24>
    15de:	00004097          	auipc	ra,0x4
    15e2:	3b8080e7          	jalr	952(ra) # 5996 <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	0d650513          	addi	a0,a0,214 # 66c8 <malloc+0xc74>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	39c080e7          	jalr	924(ra) # 5996 <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	15250513          	addi	a0,a0,338 # 6760 <malloc+0xd0c>
    1616:	00004097          	auipc	ra,0x4
    161a:	380080e7          	jalr	896(ra) # 5996 <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	86450513          	addi	a0,a0,-1948 # 5e90 <malloc+0x43c>
  ...
  if(xstatus != 0)
    ...
    1664:	12850513          	addi	a0,a0,296 # 6788 <malloc+0xd34>
    1668:	00004097          	auipc	ra,0x4
    166c:	32e080e7          	jalr	814(ra) # 5996 <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	12450513          	addi	a0,a0,292 # 67a0 <malloc+0xd4c>
    1684:	00004097          	auipc	ra,0x4
    1688:	312080e7          	jalr	786(ra) # 5996 <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	0c850513          	addi	a0,a0,200 # 6758 <malloc+0xd04>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	b6650513          	addi	a0,a0,-1178 # 6220 <malloc+0x7cc>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	2d4080e7          	jalr	724(ra) # 5996 <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	00a50513          	addi	a0,a0,10 # 66e0 <malloc+0xc8c>
    16de:	00004097          	auipc	ra,0x4
    16e2:	2b8080e7          	jalr	696(ra) # 5996 <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	06850513          	addi	a0,a0,104 # 6758 <malloc+0xd04>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	09e50513          	addi	a0,a0,158 # 67b8 <malloc+0xd64>
    1722:	00004097          	auipc	ra,0x4
    1726:	274080e7          	jalr	628(ra) # 5996 <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	322a8a93          	addi	s5,s5,802 # baa8 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	30470713          	addi	a4,a4,772 # baa8 <buf>
    ...
    17e0:	ff450513          	addi	a0,a0,-12 # 67d0 <malloc+0xd7c>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	1b2080e7          	jalr	434(ra) # 5996 <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	2a6b0b13          	addi	s6,s6,678 # baa8 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	f8650513          	addi	a0,a0,-122 # 67e8 <malloc+0xd94>
    186a:	00004097          	auipc	ra,0x4
    186e:	12c080e7          	jalr	300(ra) # 5996 <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	f8250513          	addi	a0,a0,-126 # 6800 <malloc+0xdac>
    1886:	00004097          	auipc	ra,0x4
    188a:	110080e7          	jalr	272(ra) # 5996 <printf>
}
    ...
    18b4:	f6850513          	addi	a0,a0,-152 # 6818 <malloc+0xdc4>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	0de080e7          	jalr	222(ra) # 5996 <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	f4850513          	addi	a0,a0,-184 # 6838 <malloc+0xde4>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	09e080e7          	jalr	158(ra) # 5996 <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	d6650513          	addi	a0,a0,-666 # 66c8 <malloc+0xc74>
    196a:	00004097          	auipc	ra,0x4
    196e:	02c080e7          	jalr	44(ra) # 5996 <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	ed250513          	addi	a0,a0,-302 # 6850 <malloc+0xdfc>
    1986:	00004097          	auipc	ra,0x4
    198a:	010080e7          	jalr	16(ra) # 5996 <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	ece50513          	addi	a0,a0,-306 # 6868 <malloc+0xe14>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	ff4080e7          	jalr	-12(ra) # 5996 <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	cb650513          	addi	a0,a0,-842 # 66c8 <malloc+0xc74>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	f7c080e7          	jalr	-132(ra) # 5996 <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	c9250513          	addi	a0,a0,-878 # 66c8 <malloc+0xc74>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	f58080e7          	jalr	-168(ra) # 5996 <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	dd850513          	addi	a0,a0,-552 # 6888 <malloc+0xe34>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	ede080e7          	jalr	-290(ra) # 5996 <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	b54080e7          	jalr	-1196(ra) # 5616 <exit>
{
    ...
    1b0c:	d9050513          	addi	a0,a0,-624 # 6898 <malloc+0xe44>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	e86080e7          	jalr	-378(ra) # 5996 <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	f7a50513          	addi	a0,a0,-134 # 6ad0 <malloc+0x107c>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	e38080e7          	jalr	-456(ra) # 5996 <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	edc50513          	addi	a0,a0,-292 # 6ad0 <malloc+0x107c>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	d9a080e7          	jalr	-614(ra) # 5996 <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	b4050513          	addi	a0,a0,-1216 # 6760 <malloc+0xd0c>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	d6e080e7          	jalr	-658(ra) # 5996 <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	c2650513          	addi	a0,a0,-986 # 68b8 <malloc+0xe64>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	cfc080e7          	jalr	-772(ra) # 5996 <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	c0a50513          	addi	a0,a0,-1014 # 68d0 <malloc+0xe7c>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	cc8080e7          	jalr	-824(ra) # 5996 <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	bcc50513          	addi	a0,a0,-1076 # 68f8 <malloc+0xea4>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	c62080e7          	jalr	-926(ra) # 5996 <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	13450513          	addi	a0,a0,308 # 5f00 <malloc+0x4ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	0f8a8a93          	addi	s5,s5,248 # 5f00 <malloc+0x4ac>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	b10b8b93          	addi	s7,s7,-1264 # 6920 <malloc+0xecc>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	8ac50513          	addi	a0,a0,-1876 # 66c8 <malloc+0xc74>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	b72080e7          	jalr	-1166(ra) # 5996 <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	bc650513          	addi	a0,a0,-1082 # 6ad0 <malloc+0x107c>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	a84080e7          	jalr	-1404(ra) # 5996 <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	b62b8b93          	addi	s7,s7,-1182 # baa8 <buf>
    ...
    1fbe:	96e50513          	addi	a0,a0,-1682 # 6928 <malloc+0xed4>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	9d4080e7          	jalr	-1580(ra) # 5996 <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	f7650513          	addi	a0,a0,-138 # 5f50 <malloc+0x4fc>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	9b4080e7          	jalr	-1612(ra) # 5996 <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	93050513          	addi	a0,a0,-1744 # 6958 <malloc+0xf04>
    2030:	00004097          	auipc	ra,0x4
    2034:	966080e7          	jalr	-1690(ra) # 5996 <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	8b650513          	addi	a0,a0,-1866 # 6940 <malloc+0xeec>
    2092:	00004097          	auipc	ra,0x4
    2096:	904080e7          	jalr	-1788(ra) # 5996 <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	8da50513          	addi	a0,a0,-1830 # 6980 <malloc+0xf2c>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	8e8080e7          	jalr	-1816(ra) # 5996 <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	8d650513          	addi	a0,a0,-1834 # 6998 <malloc+0xf44>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	8cc080e7          	jalr	-1844(ra) # 5996 <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x8a8>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e9c8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	58650513          	addi	a0,a0,1414 # 66c8 <malloc+0xc74>
    214a:	00004097          	auipc	ra,0x4
    214e:	84c080e7          	jalr	-1972(ra) # 5996 <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	84c50513          	addi	a0,a0,-1972 # 69b0 <malloc+0xf5c>
    216c:	00004097          	auipc	ra,0x4
    2170:	82a080e7          	jalr	-2006(ra) # 5996 <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2198:	83c50513          	addi	a0,a0,-1988 # 69d0 <malloc+0xf7c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    21ca:	80a50513          	addi	a0,a0,-2038 # 69d0 <malloc+0xf7c>
  ...
  close(fd);
    ...
    21f0:	0a478793          	addi	a5,a5,164 # 8290 <args.1842>
    21f4:	00006697          	auipc	a3,0x6
    21f8:	19468693          	addi	a3,a3,404 # 8388 <args.1842+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    21fc:	00004717          	auipc	a4,0x4
    2200:	7e470713          	addi	a4,a4,2020 # 69e0 <malloc+0xf8c>
    ...
    2254:	87050513          	addi	a0,a0,-1936 # 6ac0 <malloc+0x106c>
    2258:	00003097          	auipc	ra,0x3
    225c:	73e080e7          	jalr	1854(ra) # 5996 <printf>
    exit(1);
    2260:	4505                	li	a0,1
    ...
    2278:	86c50513          	addi	a0,a0,-1940 # 6ae0 <malloc+0x108c>
    227c:	00003097          	auipc	ra,0x3
    2280:	71a080e7          	jalr	1818(ra) # 5996 <printf>
    exit(1);
    2284:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    22cc:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0548>
    22d0:	85a6                	mv	a1,s1
    22d2:	00005517          	auipc	a0,0x5
    22d6:	82e50513          	addi	a0,a0,-2002 # 6b00 <malloc+0x10ac>
    22da:	00003097          	auipc	ra,0x3
    22de:	6bc080e7          	jalr	1724(ra) # 5996 <printf>
    exit(1);
    22e2:	4505                	li	a0,1
    ...
    22f2:	3da50513          	addi	a0,a0,986 # 66c8 <malloc+0xc74>
    22f6:	00003097          	auipc	ra,0x3
    22fa:	6a0080e7          	jalr	1696(ra) # 5996 <printf>
    exit(1);
    22fe:	4505                	li	a0,1
...
0000000000002312 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    238c:	41078793          	addi	a5,a5,1040 # 7798 <malloc+0x1d44>
  ...
  if(ret != -1){
    ...
    23ce:	75e50513          	addi	a0,a0,1886 # 6b28 <malloc+0x10d4>
    23d2:	00003097          	auipc	ra,0x3
    23d6:	5c4080e7          	jalr	1476(ra) # 5996 <printf>
    exit(1);
    23da:	4505                	li	a0,1
    ...
    23ec:	20050513          	addi	a0,a0,512 # 65e8 <malloc+0xb94>
    23f0:	00003097          	auipc	ra,0x3
    23f4:	5a6080e7          	jalr	1446(ra) # 5996 <printf>
    exit(1);
    23f8:	4505                	li	a0,1
    ...
    240a:	20250513          	addi	a0,a0,514 # 6608 <malloc+0xbb4>
    240e:	00003097          	auipc	ra,0x3
    2412:	588080e7          	jalr	1416(ra) # 5996 <printf>
    exit(1);
    2416:	4505                	li	a0,1
    ...
    242a:	20250513          	addi	a0,a0,514 # 6628 <malloc+0xbd4>
    242e:	00003097          	auipc	ra,0x3
    2432:	568080e7          	jalr	1384(ra) # 5996 <printf>
    exit(1);
    2436:	4505                	li	a0,1
    ...
    2448:	20c50513          	addi	a0,a0,524 # 6650 <malloc+0xbfc>
    244c:	00003097          	auipc	ra,0x3
    2450:	54a080e7          	jalr	1354(ra) # 5996 <printf>
    exit(1);
    2454:	4505                	li	a0,1
...
000000000000245e <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2494:	72050513          	addi	a0,a0,1824 # 5bb0 <malloc+0x15c>
  ...
  if(n >= 0){
    ...
    24c6:	6be50513          	addi	a0,a0,1726 # 6b80 <malloc+0x112c>
    24ca:	00003097          	auipc	ra,0x3
    24ce:	4cc080e7          	jalr	1228(ra) # 5996 <printf>
    exit(1);
    24d2:	4505                	li	a0,1
    ...
    24e0:	65450513          	addi	a0,a0,1620 # 6b30 <malloc+0x10dc>
    24e4:	00003097          	auipc	ra,0x3
    24e8:	4b2080e7          	jalr	1202(ra) # 5996 <printf>
    exit(1);
    24ec:	4505                	li	a0,1
    ...
    24fa:	65250513          	addi	a0,a0,1618 # 6b48 <malloc+0x10f4>
    24fe:	00003097          	auipc	ra,0x3
    2502:	498080e7          	jalr	1176(ra) # 5996 <printf>
    exit(1);
    2506:	4505                	li	a0,1
    ...
    2514:	65850513          	addi	a0,a0,1624 # 6b68 <malloc+0x1114>
    2518:	00003097          	auipc	ra,0x3
    251c:	47e080e7          	jalr	1150(ra) # 5996 <printf>
    exit(1);
    2520:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2538:	67c50513          	addi	a0,a0,1660 # 5bb0 <malloc+0x15c>
    253c:	00003097          	auipc	ra,0x3
    2540:	12a080e7          	jalr	298(ra) # 5666 <unlink>
  fd = open("README", O_RDONLY);
    2544:	4581                	li	a1,0
    2546:	00004517          	auipc	a0,0x4
    254a:	ae250513          	addi	a0,a0,-1310 # 6028 <malloc+0x5d4>
  ...
  if(n >= 0){
    ...
    2574:	64050513          	addi	a0,a0,1600 # 6bb0 <malloc+0x115c>
    2578:	00003097          	auipc	ra,0x3
    257c:	41e080e7          	jalr	1054(ra) # 5996 <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	5de50513          	addi	a0,a0,1502 # 6b68 <malloc+0x1114>
    2592:	00003097          	auipc	ra,0x3
    2596:	404080e7          	jalr	1028(ra) # 5996 <printf>
    exit(1);
    259a:	4505                	li	a0,1
...
00000000000025b8 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    25f6:	6705                	lui	a4,0x1
      *b = 99;
    25f8:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1548>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2610:	5cc50513          	addi	a0,a0,1484 # 6bd8 <malloc+0x1184>
    2614:	00003097          	auipc	ra,0x3
    2618:	382080e7          	jalr	898(ra) # 5996 <printf>
    exit(1);
    261c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2664:	59850513          	addi	a0,a0,1432 # 6bf8 <malloc+0x11a4>
    2668:	00003097          	auipc	ra,0x3
    266c:	32e080e7          	jalr	814(ra) # 5996 <printf>
    exit(1);
    2670:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    26c6:	59650513          	addi	a0,a0,1430 # 6c58 <malloc+0x1204>
    26ca:	00003097          	auipc	ra,0x3
    26ce:	2cc080e7          	jalr	716(ra) # 5996 <printf>
    exit(1);
    26d2:	4505                	li	a0,1
    ...
    26e6:	53650513          	addi	a0,a0,1334 # 6c18 <malloc+0x11c4>
    26ea:	00003097          	auipc	ra,0x3
    26ee:	2ac080e7          	jalr	684(ra) # 5996 <printf>
      exit(1);
    26f2:	4505                	li	a0,1
    ...
    2702:	53a50513          	addi	a0,a0,1338 # 6c38 <malloc+0x11e4>
    2706:	00003097          	auipc	ra,0x3
    270a:	290080e7          	jalr	656(ra) # 5996 <printf>
    exit(1);
    270e:	4505                	li	a0,1
...
000000000000273e <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    27a0:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1547>
  a = sbrk(0);
    27a4:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    2804:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1547>
  ...
  if(c != a){
    ...
    284c:	43050513          	addi	a0,a0,1072 # 6c78 <malloc+0x1224>
    2850:	00003097          	auipc	ra,0x3
    2854:	146080e7          	jalr	326(ra) # 5996 <printf>
    exit(1);
    2858:	4505                	li	a0,1
    ...
    2868:	45c50513          	addi	a0,a0,1116 # 6cc0 <malloc+0x126c>
    286c:	00003097          	auipc	ra,0x3
    2870:	12a080e7          	jalr	298(ra) # 5996 <printf>
    exit(1);
    2874:	4505                	li	a0,1
    ...
    2888:	45c50513          	addi	a0,a0,1116 # 6ce0 <malloc+0x128c>
    288c:	00003097          	auipc	ra,0x3
    2890:	10a080e7          	jalr	266(ra) # 5996 <printf>
    exit(1);
    2894:	4505                	li	a0,1
    ...
    28a8:	47c50513          	addi	a0,a0,1148 # 6d20 <malloc+0x12cc>
    28ac:	00003097          	auipc	ra,0x3
    28b0:	0ea080e7          	jalr	234(ra) # 5996 <printf>
    exit(1);
    28b4:	4505                	li	a0,1
    ...
    28c4:	49050513          	addi	a0,a0,1168 # 6d50 <malloc+0x12fc>
    28c8:	00003097          	auipc	ra,0x3
    28cc:	0ce080e7          	jalr	206(ra) # 5996 <printf>
    exit(1);
    28d0:	4505                	li	a0,1
    ...
    28e4:	4a850513          	addi	a0,a0,1192 # 6d88 <malloc+0x1334>
    28e8:	00003097          	auipc	ra,0x3
    28ec:	0ae080e7          	jalr	174(ra) # 5996 <printf>
    exit(1);
    28f0:	4505                	li	a0,1
...
00000000000028fa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    291e:	49650513          	addi	a0,a0,1174 # 6db0 <malloc+0x135c>
    2922:	00003097          	auipc	ra,0x3
    2926:	d34080e7          	jalr	-716(ra) # 5656 <open>
    292a:	84aa                	mv	s1,a0
  unlink("sbrk");
    292c:	00004517          	auipc	a0,0x4
    2930:	48450513          	addi	a0,a0,1156 # 6db0 <malloc+0x135c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2984:	43850513          	addi	a0,a0,1080 # 6db8 <malloc+0x1364>
    2988:	00003097          	auipc	ra,0x3
    298c:	00e080e7          	jalr	14(ra) # 5996 <printf>
    exit(1);
    2990:	4505                	li	a0,1
    ...
    29a0:	43450513          	addi	a0,a0,1076 # 6dd0 <malloc+0x137c>
    29a4:	00003097          	auipc	ra,0x3
    29a8:	ff2080e7          	jalr	-14(ra) # 5996 <printf>
    exit(1);
    29ac:	4505                	li	a0,1
    ...
    29bc:	e1850513          	addi	a0,a0,-488 # 67d0 <malloc+0xd7c>
    29c0:	00003097          	auipc	ra,0x3
    29c4:	fd6080e7          	jalr	-42(ra) # 5996 <printf>
    exit(1);
    29c8:	4505                	li	a0,1
...
00000000000029d2 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    29e6:	40650513          	addi	a0,a0,1030 # 6de8 <malloc+0x1394>
  ...
  close(fd);
    ...
    2a2e:	cb650513          	addi	a0,a0,-842 # 66e0 <malloc+0xc8c>
    2a32:	00003097          	auipc	ra,0x3
    2a36:	f64080e7          	jalr	-156(ra) # 5996 <printf>
    exit(1);
    2a3a:	4505                	li	a0,1
...
0000000000002a44 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2a7c:	05850513          	addi	a0,a0,88 # 6ad0 <malloc+0x107c>
    2a80:	00003097          	auipc	ra,0x3
    2a84:	f16080e7          	jalr	-234(ra) # 5996 <printf>
    exit(1);
    2a88:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2ad2:	00250513          	addi	a0,a0,2 # 6ad0 <malloc+0x107c>
    2ad6:	00003097          	auipc	ra,0x3
    2ada:	ec0080e7          	jalr	-320(ra) # 5996 <printf>
    exit(1);
    2ade:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b32:	fa250513          	addi	a0,a0,-94 # 6ad0 <malloc+0x107c>
    2b36:	00003097          	auipc	ra,0x3
    2b3a:	e60080e7          	jalr	-416(ra) # 5996 <printf>
    exit(1);
    2b3e:	4505                	li	a0,1
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2b9e:	f3650513          	addi	a0,a0,-202 # 6ad0 <malloc+0x107c>
    2ba2:	00003097          	auipc	ra,0x3
    2ba6:	df4080e7          	jalr	-524(ra) # 5996 <printf>
      exit(1);
    2baa:	4505                	li	a0,1
    ...
    2bf2:	2a250513          	addi	a0,a0,674 # 5e90 <malloc+0x43c>
    2bf6:	faa43c23          	sd	a0,-72(s0)
    2bfa:	00003797          	auipc	a5,0x3
    2bfe:	30678793          	addi	a5,a5,774 # 5f00 <malloc+0x4ac>
...
0000000000002c20 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2c30:	39450513          	addi	a0,a0,916 # 6fc0 <malloc+0x156c>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2c42:	1da50513          	addi	a0,a0,474 # 6e18 <malloc+0x13c4>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2c58:	21c50513          	addi	a0,a0,540 # 6e70 <malloc+0x141c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2c76:	27650513          	addi	a0,a0,630 # 6ee8 <malloc+0x1494>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2c92:	2ca50513          	addi	a0,a0,714 # 6f58 <malloc+0x1504>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2ca4:	31050513          	addi	a0,a0,784 # 6fb0 <malloc+0x155c>
  ...
  unlink("12345678901234");
    ...
    2d22:	0d250513          	addi	a0,a0,210 # 6df0 <malloc+0x139c>
    2d26:	00003097          	auipc	ra,0x3
    2d2a:	c70080e7          	jalr	-912(ra) # 5996 <printf>
    exit(1);
    2d2e:	4505                	li	a0,1
    ...
    2d3e:	0fe50513          	addi	a0,a0,254 # 6e38 <malloc+0x13e4>
    2d42:	00003097          	auipc	ra,0x3
    2d46:	c54080e7          	jalr	-940(ra) # 5996 <printf>
    exit(1);
    2d4a:	4505                	li	a0,1
    ...
    2d5a:	14a50513          	addi	a0,a0,330 # 6ea0 <malloc+0x144c>
    2d5e:	00003097          	auipc	ra,0x3
    2d62:	c38080e7          	jalr	-968(ra) # 5996 <printf>
    exit(1);
    2d66:	4505                	li	a0,1
    ...
    2d76:	1a650513          	addi	a0,a0,422 # 6f18 <malloc+0x14c4>
    2d7a:	00003097          	auipc	ra,0x3
    2d7e:	c1c080e7          	jalr	-996(ra) # 5996 <printf>
    exit(1);
    2d82:	4505                	li	a0,1
    ...
    2d92:	1ea50513          	addi	a0,a0,490 # 6f78 <malloc+0x1524>
    2d96:	00003097          	auipc	ra,0x3
    2d9a:	c00080e7          	jalr	-1024(ra) # 5996 <printf>
    exit(1);
    2d9e:	4505                	li	a0,1
    ...
    2dae:	22650513          	addi	a0,a0,550 # 6fd0 <malloc+0x157c>
    2db2:	00003097          	auipc	ra,0x3
    2db6:	be4080e7          	jalr	-1052(ra) # 5996 <printf>
    exit(1);
    2dba:	4505                	li	a0,1
...
0000000000002dc4 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2dd4:	23850513          	addi	a0,a0,568 # 7008 <malloc+0x15b4>
  ...
  if(chdir("iputdir") < 0){
    ...
    2de8:	22450513          	addi	a0,a0,548 # 7008 <malloc+0x15b4>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2dfc:	25050513          	addi	a0,a0,592 # 7048 <malloc+0x15f4>
  ...
  if(chdir("/") < 0){
    ...
    2e10:	26c50513          	addi	a0,a0,620 # 7078 <malloc+0x1624>
    ...
    2e30:	1e450513          	addi	a0,a0,484 # 7010 <malloc+0x15bc>
    2e34:	00003097          	auipc	ra,0x3
    2e38:	b62080e7          	jalr	-1182(ra) # 5996 <printf>
    exit(1);
    2e3c:	4505                	li	a0,1
    ...
    2e4c:	1e050513          	addi	a0,a0,480 # 7028 <malloc+0x15d4>
    2e50:	00003097          	auipc	ra,0x3
    2e54:	b46080e7          	jalr	-1210(ra) # 5996 <printf>
    exit(1);
    2e58:	4505                	li	a0,1
    ...
    2e68:	1f450513          	addi	a0,a0,500 # 7058 <malloc+0x1604>
    2e6c:	00003097          	auipc	ra,0x3
    2e70:	b2a080e7          	jalr	-1238(ra) # 5996 <printf>
    exit(1);
    2e74:	4505                	li	a0,1
    ...
    2e84:	20050513          	addi	a0,a0,512 # 7080 <malloc+0x162c>
    2e88:	00003097          	auipc	ra,0x3
    2e8c:	b0e080e7          	jalr	-1266(ra) # 5996 <printf>
    exit(1);
    2e90:	4505                	li	a0,1
...
0000000000002e9a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2eb8:	15450513          	addi	a0,a0,340 # 7008 <malloc+0x15b4>
    ...
    2ecc:	14050513          	addi	a0,a0,320 # 7008 <malloc+0x15b4>
    ...
    2ee0:	16c50513          	addi	a0,a0,364 # 7048 <malloc+0x15f4>
    ...
    2f00:	7cc50513          	addi	a0,a0,1996 # 66c8 <malloc+0xc74>
    2f04:	00003097          	auipc	ra,0x3
    2f08:	a92080e7          	jalr	-1390(ra) # 5996 <printf>
    exit(1);
    2f0c:	4505                	li	a0,1
    ...
    2f1c:	0f850513          	addi	a0,a0,248 # 7010 <malloc+0x15bc>
    2f20:	00003097          	auipc	ra,0x3
    2f24:	a76080e7          	jalr	-1418(ra) # 5996 <printf>
      exit(1);
    2f28:	4505                	li	a0,1
    ...
    2f38:	16450513          	addi	a0,a0,356 # 7098 <malloc+0x1644>
    2f3c:	00003097          	auipc	ra,0x3
    2f40:	a5a080e7          	jalr	-1446(ra) # 5996 <printf>
      exit(1);
    2f44:	4505                	li	a0,1
    ...
    2f54:	10850513          	addi	a0,a0,264 # 7058 <malloc+0x1604>
    2f58:	00003097          	auipc	ra,0x3
    2f5c:	a3e080e7          	jalr	-1474(ra) # 5996 <printf>
      exit(1);
    2f60:	4505                	li	a0,1
...
0000000000002f82 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    2f92:	12250513          	addi	a0,a0,290 # 70b0 <malloc+0x165c>
  ...
  if(chdir("dir0") < 0){
    ...
    2fa6:	10e50513          	addi	a0,a0,270 # 70b0 <malloc+0x165c>
  ...
  if(chdir("..") < 0){
    ...
    2fba:	11a50513          	addi	a0,a0,282 # 70d0 <malloc+0x167c>
  ...
  if(unlink("dir0") < 0){
    ...
    2fce:	0e650513          	addi	a0,a0,230 # 70b0 <malloc+0x165c>
    ...
    2fee:	02650513          	addi	a0,a0,38 # 7010 <malloc+0x15bc>
    2ff2:	00003097          	auipc	ra,0x3
    2ff6:	9a4080e7          	jalr	-1628(ra) # 5996 <printf>
    exit(1);
    2ffa:	4505                	li	a0,1
    ...
    300a:	0b250513          	addi	a0,a0,178 # 70b8 <malloc+0x1664>
    300e:	00003097          	auipc	ra,0x3
    3012:	988080e7          	jalr	-1656(ra) # 5996 <printf>
    exit(1);
    3016:	4505                	li	a0,1
    ...
    3026:	0b650513          	addi	a0,a0,182 # 70d8 <malloc+0x1684>
    302a:	00003097          	auipc	ra,0x3
    302e:	96c080e7          	jalr	-1684(ra) # 5996 <printf>
    exit(1);
    3032:	4505                	li	a0,1
    ...
    3042:	0b250513          	addi	a0,a0,178 # 70f0 <malloc+0x169c>
    3046:	00003097          	auipc	ra,0x3
    304a:	950080e7          	jalr	-1712(ra) # 5996 <printf>
    exit(1);
    304e:	4505                	li	a0,1
...
0000000000003058 <subdir>:
{
  ...
  unlink("ff");
    ...
    306a:	1d250513          	addi	a0,a0,466 # 7238 <malloc+0x17e4>
    306e:	00002097          	auipc	ra,0x2
    3072:	5f8080e7          	jalr	1528(ra) # 5666 <unlink>
  if(mkdir("dd") != 0){
    3076:	00004517          	auipc	a0,0x4
    307a:	09250513          	addi	a0,a0,146 # 7108 <malloc+0x16b4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3092:	09a50513          	addi	a0,a0,154 # 7128 <malloc+0x16d4>
  ...
  write(fd, "ff", 2);
    ...
    30aa:	19258593          	addi	a1,a1,402 # 7238 <malloc+0x17e4>
  ...
  if(unlink("dd") >= 0){
    ...
    30c4:	04850513          	addi	a0,a0,72 # 7108 <malloc+0x16b4>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    30d8:	0ac50513          	addi	a0,a0,172 # 7180 <malloc+0x172c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    30f0:	0bc50513          	addi	a0,a0,188 # 71a8 <malloc+0x1754>
  ...
  write(fd, "FF", 2);
    ...
    3108:	0d458593          	addi	a1,a1,212 # 71d8 <malloc+0x1784>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3124:	0c050513          	addi	a0,a0,192 # 71e0 <malloc+0x178c>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    313c:	97058593          	addi	a1,a1,-1680 # baa8 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3152:	95a74703          	lbu	a4,-1702(a4) # baa8 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    316c:	0c858593          	addi	a1,a1,200 # 7230 <malloc+0x17dc>
    3170:	00004517          	auipc	a0,0x4
    3174:	03850513          	addi	a0,a0,56 # 71a8 <malloc+0x1754>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3188:	02450513          	addi	a0,a0,36 # 71a8 <malloc+0x1754>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    319e:	00e50513          	addi	a0,a0,14 # 71a8 <malloc+0x1754>
  ...
  if(chdir("dd") != 0){
    ...
    31b2:	f5a50513          	addi	a0,a0,-166 # 7108 <malloc+0x16b4>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    31c6:	10650513          	addi	a0,a0,262 # 72c8 <malloc+0x1874>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    31da:	12250513          	addi	a0,a0,290 # 72f8 <malloc+0x18a4>
  ...
  if(chdir("./..") != 0){
    ...
    31ee:	13e50513          	addi	a0,a0,318 # 7328 <malloc+0x18d4>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3204:	03050513          	addi	a0,a0,48 # 7230 <malloc+0x17dc>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    321c:	89058593          	addi	a1,a1,-1904 # baa8 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    323e:	f6e50513          	addi	a0,a0,-146 # 71a8 <malloc+0x1754>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3256:	16650513          	addi	a0,a0,358 # 73b8 <malloc+0x1964>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    326e:	17e50513          	addi	a0,a0,382 # 73e8 <malloc+0x1994>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3286:	e8650513          	addi	a0,a0,-378 # 7108 <malloc+0x16b4>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    329c:	e7050513          	addi	a0,a0,-400 # 7108 <malloc+0x16b4>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    32b2:	e5a50513          	addi	a0,a0,-422 # 7108 <malloc+0x16b4>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    32c6:	1b658593          	addi	a1,a1,438 # 7478 <malloc+0x1a24>
    32ca:	00004517          	auipc	a0,0x4
    32ce:	0ee50513          	addi	a0,a0,238 # 73b8 <malloc+0x1964>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    32e2:	19a58593          	addi	a1,a1,410 # 7478 <malloc+0x1a24>
    32e6:	00004517          	auipc	a0,0x4
    32ea:	10250513          	addi	a0,a0,258 # 73e8 <malloc+0x1994>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    32fe:	f3658593          	addi	a1,a1,-202 # 7230 <malloc+0x17dc>
    3302:	00004517          	auipc	a0,0x4
    3306:	e2650513          	addi	a0,a0,-474 # 7128 <malloc+0x16d4>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    331a:	0a250513          	addi	a0,a0,162 # 73b8 <malloc+0x1964>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    332e:	0be50513          	addi	a0,a0,190 # 73e8 <malloc+0x1994>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3342:	ef250513          	addi	a0,a0,-270 # 7230 <malloc+0x17dc>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3356:	09650513          	addi	a0,a0,150 # 73e8 <malloc+0x1994>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    336a:	05250513          	addi	a0,a0,82 # 73b8 <malloc+0x1964>
  ...
  if(chdir("dd/ff") == 0){
    ...
    337e:	dae50513          	addi	a0,a0,-594 # 7128 <malloc+0x16d4>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3392:	23a50513          	addi	a0,a0,570 # 75c8 <malloc+0x1b74>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    33a6:	e8e50513          	addi	a0,a0,-370 # 7230 <malloc+0x17dc>
  ...
  if(unlink("dd/ff") != 0){
    ...
    33ba:	d7250513          	addi	a0,a0,-654 # 7128 <malloc+0x16d4>
  ...
  if(unlink("dd") == 0){
    ...
    33ce:	d3e50513          	addi	a0,a0,-706 # 7108 <malloc+0x16b4>
  ...
  if(unlink("dd/dd") < 0){
    ...
    33e2:	25a50513          	addi	a0,a0,602 # 7638 <malloc+0x1be4>
  ...
  if(unlink("dd") < 0){
    ...
    33f6:	d1650513          	addi	a0,a0,-746 # 7108 <malloc+0x16b4>
    ...
    3418:	cfc50513          	addi	a0,a0,-772 # 7110 <malloc+0x16bc>
    341c:	00002097          	auipc	ra,0x2
    3420:	57a080e7          	jalr	1402(ra) # 5996 <printf>
    exit(1);
    3424:	4505                	li	a0,1
    ...
    3434:	d0050513          	addi	a0,a0,-768 # 7130 <malloc+0x16dc>
    3438:	00002097          	auipc	ra,0x2
    343c:	55e080e7          	jalr	1374(ra) # 5996 <printf>
    exit(1);
    3440:	4505                	li	a0,1
    ...
    3450:	d0450513          	addi	a0,a0,-764 # 7150 <malloc+0x16fc>
    3454:	00002097          	auipc	ra,0x2
    3458:	542080e7          	jalr	1346(ra) # 5996 <printf>
    exit(1);
    345c:	4505                	li	a0,1
    ...
    346c:	d2050513          	addi	a0,a0,-736 # 7188 <malloc+0x1734>
    3470:	00002097          	auipc	ra,0x2
    3474:	526080e7          	jalr	1318(ra) # 5996 <printf>
    exit(1);
    3478:	4505                	li	a0,1
    ...
    3488:	d3450513          	addi	a0,a0,-716 # 71b8 <malloc+0x1764>
    348c:	00002097          	auipc	ra,0x2
    3490:	50a080e7          	jalr	1290(ra) # 5996 <printf>
    exit(1);
    3494:	4505                	li	a0,1
    ...
    34a4:	d5050513          	addi	a0,a0,-688 # 71f0 <malloc+0x179c>
    34a8:	00002097          	auipc	ra,0x2
    34ac:	4ee080e7          	jalr	1262(ra) # 5996 <printf>
    exit(1);
    34b0:	4505                	li	a0,1
    ...
    34c0:	d5450513          	addi	a0,a0,-684 # 7210 <malloc+0x17bc>
    34c4:	00002097          	auipc	ra,0x2
    34c8:	4d2080e7          	jalr	1234(ra) # 5996 <printf>
    exit(1);
    34cc:	4505                	li	a0,1
    ...
    34dc:	d6850513          	addi	a0,a0,-664 # 7240 <malloc+0x17ec>
    34e0:	00002097          	auipc	ra,0x2
    34e4:	4b6080e7          	jalr	1206(ra) # 5996 <printf>
    exit(1);
    34e8:	4505                	li	a0,1
    ...
    34f8:	d7450513          	addi	a0,a0,-652 # 7268 <malloc+0x1814>
    34fc:	00002097          	auipc	ra,0x2
    3500:	49a080e7          	jalr	1178(ra) # 5996 <printf>
    exit(1);
    3504:	4505                	li	a0,1
    ...
    3514:	d7850513          	addi	a0,a0,-648 # 7288 <malloc+0x1834>
    3518:	00002097          	auipc	ra,0x2
    351c:	47e080e7          	jalr	1150(ra) # 5996 <printf>
    exit(1);
    3520:	4505                	li	a0,1
    ...
    3530:	d8450513          	addi	a0,a0,-636 # 72b0 <malloc+0x185c>
    3534:	00002097          	auipc	ra,0x2
    3538:	462080e7          	jalr	1122(ra) # 5996 <printf>
    exit(1);
    353c:	4505                	li	a0,1
    ...
    354c:	d9050513          	addi	a0,a0,-624 # 72d8 <malloc+0x1884>
    3550:	00002097          	auipc	ra,0x2
    3554:	446080e7          	jalr	1094(ra) # 5996 <printf>
    exit(1);
    3558:	4505                	li	a0,1
    ...
    3568:	da450513          	addi	a0,a0,-604 # 7308 <malloc+0x18b4>
    356c:	00002097          	auipc	ra,0x2
    3570:	42a080e7          	jalr	1066(ra) # 5996 <printf>
    exit(1);
    3574:	4505                	li	a0,1
    ...
    3584:	db050513          	addi	a0,a0,-592 # 7330 <malloc+0x18dc>
    3588:	00002097          	auipc	ra,0x2
    358c:	40e080e7          	jalr	1038(ra) # 5996 <printf>
    exit(1);
    3590:	4505                	li	a0,1
    ...
    35a0:	dac50513          	addi	a0,a0,-596 # 7348 <malloc+0x18f4>
    35a4:	00002097          	auipc	ra,0x2
    35a8:	3f2080e7          	jalr	1010(ra) # 5996 <printf>
    exit(1);
    35ac:	4505                	li	a0,1
    ...
    35bc:	db050513          	addi	a0,a0,-592 # 7368 <malloc+0x1914>
    35c0:	00002097          	auipc	ra,0x2
    35c4:	3d6080e7          	jalr	982(ra) # 5996 <printf>
    exit(1);
    35c8:	4505                	li	a0,1
    ...
    35d8:	db450513          	addi	a0,a0,-588 # 7388 <malloc+0x1934>
    35dc:	00002097          	auipc	ra,0x2
    35e0:	3ba080e7          	jalr	954(ra) # 5996 <printf>
    exit(1);
    35e4:	4505                	li	a0,1
    ...
    35f4:	dd850513          	addi	a0,a0,-552 # 73c8 <malloc+0x1974>
    35f8:	00002097          	auipc	ra,0x2
    35fc:	39e080e7          	jalr	926(ra) # 5996 <printf>
    exit(1);
    3600:	4505                	li	a0,1
    ...
    3610:	dec50513          	addi	a0,a0,-532 # 73f8 <malloc+0x19a4>
    3614:	00002097          	auipc	ra,0x2
    3618:	382080e7          	jalr	898(ra) # 5996 <printf>
    exit(1);
    361c:	4505                	li	a0,1
    ...
    362c:	df050513          	addi	a0,a0,-528 # 7418 <malloc+0x19c4>
    3630:	00002097          	auipc	ra,0x2
    3634:	366080e7          	jalr	870(ra) # 5996 <printf>
    exit(1);
    3638:	4505                	li	a0,1
    ...
    3648:	df450513          	addi	a0,a0,-524 # 7438 <malloc+0x19e4>
    364c:	00002097          	auipc	ra,0x2
    3650:	34a080e7          	jalr	842(ra) # 5996 <printf>
    exit(1);
    3654:	4505                	li	a0,1
    ...
    3664:	df850513          	addi	a0,a0,-520 # 7458 <malloc+0x1a04>
    3668:	00002097          	auipc	ra,0x2
    366c:	32e080e7          	jalr	814(ra) # 5996 <printf>
    exit(1);
    3670:	4505                	li	a0,1
    ...
    3680:	e0c50513          	addi	a0,a0,-500 # 7488 <malloc+0x1a34>
    3684:	00002097          	auipc	ra,0x2
    3688:	312080e7          	jalr	786(ra) # 5996 <printf>
    exit(1);
    368c:	4505                	li	a0,1
    ...
    369c:	e1850513          	addi	a0,a0,-488 # 74b0 <malloc+0x1a5c>
    36a0:	00002097          	auipc	ra,0x2
    36a4:	2f6080e7          	jalr	758(ra) # 5996 <printf>
    exit(1);
    36a8:	4505                	li	a0,1
    ...
    36b8:	e2450513          	addi	a0,a0,-476 # 74d8 <malloc+0x1a84>
    36bc:	00002097          	auipc	ra,0x2
    36c0:	2da080e7          	jalr	730(ra) # 5996 <printf>
    exit(1);
    36c4:	4505                	li	a0,1
    ...
    36d4:	e3050513          	addi	a0,a0,-464 # 7500 <malloc+0x1aac>
    36d8:	00002097          	auipc	ra,0x2
    36dc:	2be080e7          	jalr	702(ra) # 5996 <printf>
    exit(1);
    36e0:	4505                	li	a0,1
    ...
    36f0:	e3450513          	addi	a0,a0,-460 # 7520 <malloc+0x1acc>
    36f4:	00002097          	auipc	ra,0x2
    36f8:	2a2080e7          	jalr	674(ra) # 5996 <printf>
    exit(1);
    36fc:	4505                	li	a0,1
    ...
    370c:	e3850513          	addi	a0,a0,-456 # 7540 <malloc+0x1aec>
    3710:	00002097          	auipc	ra,0x2
    3714:	286080e7          	jalr	646(ra) # 5996 <printf>
    exit(1);
    3718:	4505                	li	a0,1
    ...
    3728:	e4450513          	addi	a0,a0,-444 # 7568 <malloc+0x1b14>
    372c:	00002097          	auipc	ra,0x2
    3730:	26a080e7          	jalr	618(ra) # 5996 <printf>
    exit(1);
    3734:	4505                	li	a0,1
    ...
    3744:	e4850513          	addi	a0,a0,-440 # 7588 <malloc+0x1b34>
    3748:	00002097          	auipc	ra,0x2
    374c:	24e080e7          	jalr	590(ra) # 5996 <printf>
    exit(1);
    3750:	4505                	li	a0,1
    ...
    3760:	e4c50513          	addi	a0,a0,-436 # 75a8 <malloc+0x1b54>
    3764:	00002097          	auipc	ra,0x2
    3768:	232080e7          	jalr	562(ra) # 5996 <printf>
    exit(1);
    376c:	4505                	li	a0,1
    ...
    377c:	e5850513          	addi	a0,a0,-424 # 75d0 <malloc+0x1b7c>
    3780:	00002097          	auipc	ra,0x2
    3784:	216080e7          	jalr	534(ra) # 5996 <printf>
    exit(1);
    3788:	4505                	li	a0,1
    ...
    3798:	ad450513          	addi	a0,a0,-1324 # 7268 <malloc+0x1814>
    379c:	00002097          	auipc	ra,0x2
    37a0:	1fa080e7          	jalr	506(ra) # 5996 <printf>
    exit(1);
    37a4:	4505                	li	a0,1
    ...
    37b4:	e4050513          	addi	a0,a0,-448 # 75f0 <malloc+0x1b9c>
    37b8:	00002097          	auipc	ra,0x2
    37bc:	1de080e7          	jalr	478(ra) # 5996 <printf>
    exit(1);
    37c0:	4505                	li	a0,1
    ...
    37d0:	e4450513          	addi	a0,a0,-444 # 7610 <malloc+0x1bbc>
    37d4:	00002097          	auipc	ra,0x2
    37d8:	1c2080e7          	jalr	450(ra) # 5996 <printf>
    exit(1);
    37dc:	4505                	li	a0,1
    ...
    37ec:	e5850513          	addi	a0,a0,-424 # 7640 <malloc+0x1bec>
    37f0:	00002097          	auipc	ra,0x2
    37f4:	1a6080e7          	jalr	422(ra) # 5996 <printf>
    exit(1);
    37f8:	4505                	li	a0,1
    ...
    3808:	e5c50513          	addi	a0,a0,-420 # 7660 <malloc+0x1c0c>
    380c:	00002097          	auipc	ra,0x2
    3810:	18a080e7          	jalr	394(ra) # 5996 <printf>
    exit(1);
    3814:	4505                	li	a0,1
...
000000000000381e <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    382e:	e4e50513          	addi	a0,a0,-434 # 7678 <malloc+0x1c24>
  ...
  if(chdir("dots") != 0){
    ...
    3840:	e3c50513          	addi	a0,a0,-452 # 7678 <malloc+0x1c24>
  ...
  if(unlink(".") == 0){
    ...
    3852:	cda50513          	addi	a0,a0,-806 # 6528 <malloc+0xad4>
  ...
  if(unlink("..") == 0){
    ...
    3864:	87050513          	addi	a0,a0,-1936 # 70d0 <malloc+0x167c>
  ...
  if(chdir("/") != 0){
    ...
    3876:	80650513          	addi	a0,a0,-2042 # 7078 <malloc+0x1624>
  ...
  if(unlink("dots/.") == 0){
    ...
    3888:	e5c50513          	addi	a0,a0,-420 # 76e0 <malloc+0x1c8c>
  ...
  if(unlink("dots/..") == 0){
    ...
    389a:	e7250513          	addi	a0,a0,-398 # 7708 <malloc+0x1cb4>
  ...
  if(unlink("dots") != 0){
    ...
    38ac:	dd050513          	addi	a0,a0,-560 # 7678 <malloc+0x1c24>
    ...
    38ca:	dba50513          	addi	a0,a0,-582 # 7680 <malloc+0x1c2c>
    38ce:	00002097          	auipc	ra,0x2
    38d2:	0c8080e7          	jalr	200(ra) # 5996 <printf>
    exit(1);
    38d6:	4505                	li	a0,1
    ...
    38e6:	db650513          	addi	a0,a0,-586 # 7698 <malloc+0x1c44>
    38ea:	00002097          	auipc	ra,0x2
    38ee:	0ac080e7          	jalr	172(ra) # 5996 <printf>
    exit(1);
    38f2:	4505                	li	a0,1
    ...
    3902:	db250513          	addi	a0,a0,-590 # 76b0 <malloc+0x1c5c>
    3906:	00002097          	auipc	ra,0x2
    390a:	090080e7          	jalr	144(ra) # 5996 <printf>
    exit(1);
    390e:	4505                	li	a0,1
    ...
    391e:	dae50513          	addi	a0,a0,-594 # 76c8 <malloc+0x1c74>
    3922:	00002097          	auipc	ra,0x2
    3926:	074080e7          	jalr	116(ra) # 5996 <printf>
    exit(1);
    392a:	4505                	li	a0,1
    ...
    393a:	74a50513          	addi	a0,a0,1866 # 7080 <malloc+0x162c>
    393e:	00002097          	auipc	ra,0x2
    3942:	058080e7          	jalr	88(ra) # 5996 <printf>
    exit(1);
    3946:	4505                	li	a0,1
    ...
    3956:	d9650513          	addi	a0,a0,-618 # 76e8 <malloc+0x1c94>
    395a:	00002097          	auipc	ra,0x2
    395e:	03c080e7          	jalr	60(ra) # 5996 <printf>
    exit(1);
    3962:	4505                	li	a0,1
    ...
    3972:	da250513          	addi	a0,a0,-606 # 7710 <malloc+0x1cbc>
    3976:	00002097          	auipc	ra,0x2
    397a:	020080e7          	jalr	32(ra) # 5996 <printf>
    exit(1);
    397e:	4505                	li	a0,1
    ...
    398e:	da650513          	addi	a0,a0,-602 # 7730 <malloc+0x1cdc>
    3992:	00002097          	auipc	ra,0x2
    3996:	004080e7          	jalr	4(ra) # 5996 <printf>
    exit(1);
    399a:	4505                	li	a0,1
...
00000000000039a4 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    39ba:	47a50513          	addi	a0,a0,1146 # 5e30 <malloc+0x3dc>
  ...
  if(chdir("dirfile") == 0){
    ...
    39d6:	45e50513          	addi	a0,a0,1118 # 5e30 <malloc+0x3dc>
  ...
  fd = open("dirfile/xx", 0);
    ...
    39ea:	daa50513          	addi	a0,a0,-598 # 7790 <malloc+0x1d3c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3a02:	d9250513          	addi	a0,a0,-622 # 7790 <malloc+0x1d3c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3a16:	d7e50513          	addi	a0,a0,-642 # 7790 <malloc+0x1d3c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3a2a:	d6a50513          	addi	a0,a0,-662 # 7790 <malloc+0x1d3c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3a3e:	d5658593          	addi	a1,a1,-682 # 7790 <malloc+0x1d3c>
    3a42:	00002517          	auipc	a0,0x2
    3a46:	5e650513          	addi	a0,a0,1510 # 6028 <malloc+0x5d4>
  ...
  if(unlink("dirfile") != 0){
    ...
    3a5a:	3da50513          	addi	a0,a0,986 # 5e30 <malloc+0x3dc>
  ...
  fd = open(".", O_RDWR);
    ...
    3a70:	abc50513          	addi	a0,a0,-1348 # 6528 <malloc+0xad4>
  ...
  fd = open(".", 0);
    ...
    3a86:	aa650513          	addi	a0,a0,-1370 # 6528 <malloc+0xad4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3a9a:	46a58593          	addi	a1,a1,1130 # 5f00 <malloc+0x4ac>
  ...
  close(fd);
    ...
    3ac6:	c8e50513          	addi	a0,a0,-882 # 7750 <malloc+0x1cfc>
    3aca:	00002097          	auipc	ra,0x2
    3ace:	ecc080e7          	jalr	-308(ra) # 5996 <printf>
    exit(1);
    3ad2:	4505                	li	a0,1
    ...
    3ae2:	c9250513          	addi	a0,a0,-878 # 7770 <malloc+0x1d1c>
    3ae6:	00002097          	auipc	ra,0x2
    3aea:	eb0080e7          	jalr	-336(ra) # 5996 <printf>
    exit(1);
    3aee:	4505                	li	a0,1
    ...
    3afe:	ca650513          	addi	a0,a0,-858 # 77a0 <malloc+0x1d4c>
    3b02:	00002097          	auipc	ra,0x2
    3b06:	e94080e7          	jalr	-364(ra) # 5996 <printf>
    exit(1);
    3b0a:	4505                	li	a0,1
    ...
    3b1a:	c8a50513          	addi	a0,a0,-886 # 77a0 <malloc+0x1d4c>
    3b1e:	00002097          	auipc	ra,0x2
    3b22:	e78080e7          	jalr	-392(ra) # 5996 <printf>
    exit(1);
    3b26:	4505                	li	a0,1
    ...
    3b36:	c9650513          	addi	a0,a0,-874 # 77c8 <malloc+0x1d74>
    3b3a:	00002097          	auipc	ra,0x2
    3b3e:	e5c080e7          	jalr	-420(ra) # 5996 <printf>
    exit(1);
    3b42:	4505                	li	a0,1
    ...
    3b52:	ca250513          	addi	a0,a0,-862 # 77f0 <malloc+0x1d9c>
    3b56:	00002097          	auipc	ra,0x2
    3b5a:	e40080e7          	jalr	-448(ra) # 5996 <printf>
    exit(1);
    3b5e:	4505                	li	a0,1
    ...
    3b6e:	cae50513          	addi	a0,a0,-850 # 7818 <malloc+0x1dc4>
    3b72:	00002097          	auipc	ra,0x2
    3b76:	e24080e7          	jalr	-476(ra) # 5996 <printf>
    exit(1);
    3b7a:	4505                	li	a0,1
    ...
    3b8a:	cba50513          	addi	a0,a0,-838 # 7840 <malloc+0x1dec>
    3b8e:	00002097          	auipc	ra,0x2
    3b92:	e08080e7          	jalr	-504(ra) # 5996 <printf>
    exit(1);
    3b96:	4505                	li	a0,1
    ...
    3ba6:	cbe50513          	addi	a0,a0,-834 # 7860 <malloc+0x1e0c>
    3baa:	00002097          	auipc	ra,0x2
    3bae:	dec080e7          	jalr	-532(ra) # 5996 <printf>
    exit(1);
    3bb2:	4505                	li	a0,1
    ...
    3bc2:	cca50513          	addi	a0,a0,-822 # 7888 <malloc+0x1e34>
    3bc6:	00002097          	auipc	ra,0x2
    3bca:	dd0080e7          	jalr	-560(ra) # 5996 <printf>
    exit(1);
    3bce:	4505                	li	a0,1
...
0000000000003bd8 <iref>:
{
    ...
    3bf6:	caea0a13          	addi	s4,s4,-850 # 78a0 <malloc+0x1e4c>
    mkdir("");
    3bfa:	00003497          	auipc	s1,0x3
    3bfe:	7b648493          	addi	s1,s1,1974 # 73b0 <malloc+0x195c>
    link("README", "");
    3c02:	00002a97          	auipc	s5,0x2
    3c06:	426a8a93          	addi	s5,s5,1062 # 6028 <malloc+0x5d4>
    fd = open("xx", O_CREATE);
    3c0a:	00004997          	auipc	s3,0x4
    3c0e:	b8e98993          	addi	s3,s3,-1138 # 7798 <malloc+0x1d44>
    3c12:	a891                	j	3c66 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3c14:	85da                	mv	a1,s6
    3c16:	00004517          	auipc	a0,0x4
    3c1a:	c9250513          	addi	a0,a0,-878 # 78a8 <malloc+0x1e54>
    3c1e:	00002097          	auipc	ra,0x2
    3c22:	d78080e7          	jalr	-648(ra) # 5996 <printf>
      exit(1);
    3c26:	4505                	li	a0,1
    ...
    3c36:	c8e50513          	addi	a0,a0,-882 # 78c0 <malloc+0x1e6c>
    3c3a:	00002097          	auipc	ra,0x2
    3c3e:	d5c080e7          	jalr	-676(ra) # 5996 <printf>
      exit(1);
    3c42:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3cca:	40a98993          	addi	s3,s3,1034 # 70d0 <malloc+0x167c>
    unlink("irefd");
    3cce:	00004917          	auipc	s2,0x4
    3cd2:	bd290913          	addi	s2,s2,-1070 # 78a0 <malloc+0x1e4c>
    chdir("..");
    3cd6:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3cf2:	38a50513          	addi	a0,a0,906 # 7078 <malloc+0x1624>
...
0000000000003d12 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3d22:	bba50513          	addi	a0,a0,-1094 # 78d8 <malloc+0x1e84>
  ...
  if(pid == 0){
    ...
    3d46:	b9650513          	addi	a0,a0,-1130 # 78d8 <malloc+0x1e84>
    ...
    3d5c:	ba050513          	addi	a0,a0,-1120 # 78f8 <malloc+0x1ea4>
    3d60:	00002097          	auipc	ra,0x2
    3d64:	c36080e7          	jalr	-970(ra) # 5996 <printf>
      exit(1);
    3d68:	4505                	li	a0,1
    ...
    3d78:	b6c50513          	addi	a0,a0,-1172 # 78e0 <malloc+0x1e8c>
    3d7c:	00002097          	auipc	ra,0x2
    3d80:	c1a080e7          	jalr	-998(ra) # 5996 <printf>
    exit(1);
    3d84:	4505                	li	a0,1
    ...
    3d94:	93850513          	addi	a0,a0,-1736 # 66c8 <malloc+0xc74>
    3d98:	00002097          	auipc	ra,0x2
    3d9c:	bfe080e7          	jalr	-1026(ra) # 5996 <printf>
    exit(1);
    3da0:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3dc2:	b1a50513          	addi	a0,a0,-1254 # 78d8 <malloc+0x1e84>
    ...
    3dd6:	ae650513          	addi	a0,a0,-1306 # 68b8 <malloc+0xe64>
    3dda:	00002097          	auipc	ra,0x2
    3dde:	bbc080e7          	jalr	-1092(ra) # 5996 <printf>
    exit(1);
    3de2:	4505                	li	a0,1
...
0000000000003e04 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3e14:	b1050513          	addi	a0,a0,-1264 # 7920 <malloc+0x1ecc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3e40:	ae450513          	addi	a0,a0,-1308 # 7920 <malloc+0x1ecc>
  ...
  sleep(10); // one second
    ...
    3e78:	a1450513          	addi	a0,a0,-1516 # 6888 <malloc+0xe34>
    3e7c:	00002097          	auipc	ra,0x2
    3e80:	b1a080e7          	jalr	-1254(ra) # 5996 <printf>
    exit(1);
    3e84:	4505                	li	a0,1
    ...
    3e92:	a9248493          	addi	s1,s1,-1390 # 7920 <malloc+0x1ecc>
    3e96:	4581                	li	a1,0
    3e98:	8526                	mv	a0,s1
...
0000000000003ed4 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3efe:	98e50513          	addi	a0,a0,-1650 # 6888 <malloc+0xe34>
    3f02:	00002097          	auipc	ra,0x2
    3f06:	a94080e7          	jalr	-1388(ra) # 5996 <printf>
    exit(1);
    3f0a:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3f2c:	7a050513          	addi	a0,a0,1952 # 66c8 <malloc+0xc74>
    3f30:	00002097          	auipc	ra,0x2
    3f34:	a66080e7          	jalr	-1434(ra) # 5996 <printf>
    exit(1);
    3f38:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    3f70:	f9458593          	addi	a1,a1,-108 # 5f00 <malloc+0x4ac>
    ...
    3f9a:	73250513          	addi	a0,a0,1842 # 66c8 <malloc+0xc74>
    3f9e:	00002097          	auipc	ra,0x2
    3fa2:	9f8080e7          	jalr	-1544(ra) # 5996 <printf>
     exit(1);
    3fa6:	4505                	li	a0,1
    ...
    3fb6:	97e50513          	addi	a0,a0,-1666 # 7930 <malloc+0x1edc>
    3fba:	00002097          	auipc	ra,0x2
    3fbe:	9dc080e7          	jalr	-1572(ra) # 5996 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3fd6:	ad658593          	addi	a1,a1,-1322 # baa8 <buf>
    ...
    3ff2:	95a50513          	addi	a0,a0,-1702 # 7948 <malloc+0x1ef4>
    3ff6:	00002097          	auipc	ra,0x2
    3ffa:	9a0080e7          	jalr	-1632(ra) # 5996 <printf>
}
  ...
  printf("kill... ");
    ...
    401e:	94650513          	addi	a0,a0,-1722 # 7960 <malloc+0x1f0c>
    4022:	00002097          	auipc	ra,0x2
    4026:	974080e7          	jalr	-1676(ra) # 5996 <printf>
  kill(pid1);
    402a:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    404c:	92850513          	addi	a0,a0,-1752 # 7970 <malloc+0x1f1c>
    4050:	00002097          	auipc	ra,0x2
    4054:	946080e7          	jalr	-1722(ra) # 5996 <printf>
  wait(0);
    4058:	4501                	li	a0,0
...
0000000000004078 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    40ae:	72650513          	addi	a0,a0,1830 # 67d0 <malloc+0xd7c>
    40b2:	00002097          	auipc	ra,0x2
    40b6:	8e4080e7          	jalr	-1820(ra) # 5996 <printf>
    exit(1);
    40ba:	4505                	li	a0,1
    ...
    40e4:	e2058593          	addi	a1,a1,-480 # 5f00 <malloc+0x4ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    41a8:	7dc50513          	addi	a0,a0,2012 # 7980 <malloc+0x1f2c>
    41ac:	00001097          	auipc	ra,0x1
    41b0:	7ea080e7          	jalr	2026(ra) # 5996 <printf>
    exit(1);
    41b4:	4505                	li	a0,1
    ...
    41c4:	50850513          	addi	a0,a0,1288 # 66c8 <malloc+0xc74>
    41c8:	00001097          	auipc	ra,0x1
    41cc:	7ce080e7          	jalr	1998(ra) # 5996 <printf>
    exit(1);
    41d0:	4505                	li	a0,1
    ...
    4210:	79450513          	addi	a0,a0,1940 # 79a0 <malloc+0x1f4c>
    4214:	00001097          	auipc	ra,0x1
    4218:	782080e7          	jalr	1922(ra) # 5996 <printf>
    exit(1);
    421c:	4505                	li	a0,1
...
0000000000004230 <reparent>:
{
  ...
  exit(0);
    ...
    4284:	44850513          	addi	a0,a0,1096 # 66c8 <malloc+0xc74>
    4288:	00001097          	auipc	ra,0x1
    428c:	70e080e7          	jalr	1806(ra) # 5996 <printf>
      exit(1);
    4290:	4505                	li	a0,1
    ...
    42a0:	5b450513          	addi	a0,a0,1460 # 6850 <malloc+0xdfc>
    42a4:	00001097          	auipc	ra,0x1
    42a8:	6f2080e7          	jalr	1778(ra) # 5996 <printf>
        exit(1);
    42ac:	4505                	li	a0,1
...
00000000000042e0 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4308:	750080e7          	jalr	1872(ra) # 5a54 <malloc>
    ...
    4348:	68c50513          	addi	a0,a0,1676 # 79d0 <malloc+0x1f7c>
    434c:	00001097          	auipc	ra,0x1
    4350:	64a080e7          	jalr	1610(ra) # 5996 <printf>
      exit(1);
    4354:	4505                	li	a0,1
...
0000000000004386 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    441c:	5d850513          	addi	a0,a0,1496 # 79f0 <malloc+0x1f9c>
    4420:	00001097          	auipc	ra,0x1
    4424:	576080e7          	jalr	1398(ra) # 5996 <printf>
    exit(1);
    4428:	4505                	li	a0,1
    ...
    4438:	5e450513          	addi	a0,a0,1508 # 7a18 <malloc+0x1fc4>
    443c:	00001097          	auipc	ra,0x1
    4440:	55a080e7          	jalr	1370(ra) # 5996 <printf>
      exit(1);
    4444:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    447c:	85850513          	addi	a0,a0,-1960 # 5cd0 <malloc+0x27c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    44bc:	58050513          	addi	a0,a0,1408 # 7a38 <malloc+0x1fe4>
    44c0:	00001097          	auipc	ra,0x1
    44c4:	4d6080e7          	jalr	1238(ra) # 5996 <printf>
    exit(1);
    44c8:	4505                	li	a0,1
    ...
    44d6:	fd2783e3          	beq	a5,s2,449c <sharedfd+0x116>
      if(buf[i] == 'c')
    44da:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1548>
  ...
  unlink("sharedfd");
    ...
    44f8:	7dc50513          	addi	a0,a0,2012 # 5cd0 <malloc+0x27c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    451e:	54650513          	addi	a0,a0,1350 # 7a60 <malloc+0x200c>
    4522:	00001097          	auipc	ra,0x1
    4526:	474080e7          	jalr	1140(ra) # 5996 <printf>
    exit(1);
    452a:	4505                	li	a0,1
...
000000000000453e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4562:	5da78793          	addi	a5,a5,1498 # 5b38 <malloc+0xe4>
    4566:	f6f43823          	sd	a5,-144(s0)
    456a:	00001797          	auipc	a5,0x1
    456e:	5d678793          	addi	a5,a5,1494 # 5b40 <malloc+0xec>
    4572:	f6f43c23          	sd	a5,-136(s0)
    4576:	00001797          	auipc	a5,0x1
    457a:	5d278793          	addi	a5,a5,1490 # 5b48 <malloc+0xf4>
    457e:	f8f43023          	sd	a5,-128(s0)
    4582:	00001797          	auipc	a5,0x1
    4586:	5ce78793          	addi	a5,a5,1486 # 5b50 <malloc+0xfc>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    45e0:	4cca0a13          	addi	s4,s4,1228 # baa8 <buf>
    45e4:	00007a97          	auipc	s5,0x7
    45e8:	4c5a8a93          	addi	s5,s5,1221 # baa9 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    45fe:	4d650513          	addi	a0,a0,1238 # 6ad0 <malloc+0x107c>
    4602:	00001097          	auipc	ra,0x1
    4606:	394080e7          	jalr	916(ra) # 5996 <printf>
      exit(1);
    460a:	4505                	li	a0,1
    ...
    4678:	40450513          	addi	a0,a0,1028 # 7a78 <malloc+0x2024>
    467c:	00001097          	auipc	ra,0x1
    4680:	31a080e7          	jalr	794(ra) # 5996 <printf>
        exit(1);
    4684:	4505                	li	a0,1
    ...
    4692:	3fa50513          	addi	a0,a0,1018 # 7a88 <malloc+0x2034>
    4696:	00001097          	auipc	ra,0x1
    469a:	300080e7          	jalr	768(ra) # 5996 <printf>
          exit(1);
    469e:	4505                	li	a0,1
    ...
    46b6:	3ee50513          	addi	a0,a0,1006 # 7aa0 <malloc+0x204c>
    46ba:	00001097          	auipc	ra,0x1
    46be:	2dc080e7          	jalr	732(ra) # 5996 <printf>
          exit(1);
    46c2:	4505                	li	a0,1
    ...
    46e6:	3c678793          	addi	a5,a5,966 # baa8 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4746:	36e50513          	addi	a0,a0,878 # 7ab0 <malloc+0x205c>
    474a:	00001097          	auipc	ra,0x1
    474e:	24c080e7          	jalr	588(ra) # 5996 <printf>
      exit(1);
    4752:	4505                	li	a0,1
...
000000000000477a <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    47a8:	324b8b93          	addi	s7,s7,804 # 7ac8 <malloc+0x2074>
  for(i = 0; i < N; i++){
    ...
    47ea:	2ea50513          	addi	a0,a0,746 # 7ad0 <malloc+0x207c>
    47ee:	00001097          	auipc	ra,0x1
    47f2:	1a8080e7          	jalr	424(ra) # 5996 <printf>
        exit(1);
    47f6:	4505                	li	a0,1
    ...
    4808:	2c450513          	addi	a0,a0,708 # 7ac8 <malloc+0x2074>
  ...
  fd = open(".", 0);
    ...
    4840:	cec50513          	addi	a0,a0,-788 # 6528 <malloc+0xad4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4866:	28e50513          	addi	a0,a0,654 # 7af0 <malloc+0x209c>
    486a:	00001097          	auipc	ra,0x1
    486e:	12c080e7          	jalr	300(ra) # 5996 <printf>
        exit(1);
    4872:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    48d6:	23e50513          	addi	a0,a0,574 # 7b10 <malloc+0x20bc>
    48da:	00001097          	auipc	ra,0x1
    48de:	0bc080e7          	jalr	188(ra) # 5996 <printf>
        exit(1);
    48e2:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    490e:	22e50513          	addi	a0,a0,558 # 7b38 <malloc+0x20e4>
    4912:	00001097          	auipc	ra,0x1
    4916:	084080e7          	jalr	132(ra) # 5996 <printf>
    exit(1);
    491a:	4505                	li	a0,1
    ...
    492a:	da250513          	addi	a0,a0,-606 # 66c8 <malloc+0xc74>
    492e:	00001097          	auipc	ra,0x1
    4932:	068080e7          	jalr	104(ra) # 5996 <printf>
      exit(1);
    4936:	4505                	li	a0,1
...
0000000000004ad4 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4b14:	f9890913          	addi	s2,s2,-104 # baa8 <buf>
  for(i = 0; i < N; i++){
    4b18:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4b5c:	01850513          	addi	a0,a0,24 # 7b70 <malloc+0x211c>
  ...
  for(i = 0; ; i++){
    ...
    4b72:	f3a90913          	addi	s2,s2,-198 # baa8 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4bc0:	fc450513          	addi	a0,a0,-60 # 7b80 <malloc+0x212c>
    4bc4:	00001097          	auipc	ra,0x1
    4bc8:	dd2080e7          	jalr	-558(ra) # 5996 <printf>
    exit(1);
    4bcc:	4505                	li	a0,1
    ...
    4bdc:	fc850513          	addi	a0,a0,-56 # 7ba0 <malloc+0x214c>
    4be0:	00001097          	auipc	ra,0x1
    4be4:	db6080e7          	jalr	-586(ra) # 5996 <printf>
      exit(1);
    4be8:	4505                	li	a0,1
    ...
    4bf8:	fcc50513          	addi	a0,a0,-52 # 7bc0 <malloc+0x216c>
    4bfc:	00001097          	auipc	ra,0x1
    4c00:	d9a080e7          	jalr	-614(ra) # 5996 <printf>
    exit(1);
    4c04:	4505                	li	a0,1
    ...
    4c14:	fd050513          	addi	a0,a0,-48 # 7be0 <malloc+0x218c>
    4c18:	00001097          	auipc	ra,0x1
    4c1c:	d7e080e7          	jalr	-642(ra) # 5996 <printf>
      exit(1);
    4c20:	4505                	li	a0,1
    ...
    4c30:	fd450513          	addi	a0,a0,-44 # 7c00 <malloc+0x21ac>
    4c34:	00001097          	auipc	ra,0x1
    4c38:	d62080e7          	jalr	-670(ra) # 5996 <printf>
      exit(1);
    4c3c:	4505                	li	a0,1
    ...
    4c4c:	fd050513          	addi	a0,a0,-48 # 7c18 <malloc+0x21c4>
    4c50:	00001097          	auipc	ra,0x1
    4c54:	d46080e7          	jalr	-698(ra) # 5996 <printf>
      exit(1);
    4c58:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4c7a:	efa50513          	addi	a0,a0,-262 # 7b70 <malloc+0x211c>
    ...
    4c9e:	f9e50513          	addi	a0,a0,-98 # 7c38 <malloc+0x21e4>
    4ca2:	00001097          	auipc	ra,0x1
    4ca6:	cf4080e7          	jalr	-780(ra) # 5996 <printf>
    exit(1);
    4caa:	4505                	li	a0,1
...
0000000000004cb4 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4cd6:	f8650513          	addi	a0,a0,-122 # 7c58 <malloc+0x2204>
    4cda:	00001097          	auipc	ra,0x1
    4cde:	cbc080e7          	jalr	-836(ra) # 5996 <printf>
  for(nfiles = 0; ; nfiles++){
    4ce2:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4cf6:	f76c8c93          	addi	s9,s9,-138 # 7c68 <malloc+0x2214>
    int total = 0;
    4cfa:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4cfc:	00007a17          	auipc	s4,0x7
    4d00:	daca0a13          	addi	s4,s4,-596 # baa8 <buf>
    name[0] = 'f';
    ...
    4d4e:	c4c080e7          	jalr	-948(ra) # 5996 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4d70:	f0c50513          	addi	a0,a0,-244 # 7c78 <malloc+0x2224>
    4d74:	00001097          	auipc	ra,0x1
    4d78:	c22080e7          	jalr	-990(ra) # 5996 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4de6:	eb650513          	addi	a0,a0,-330 # 7c98 <malloc+0x2244>
    4dea:	00001097          	auipc	ra,0x1
    4dee:	bac080e7          	jalr	-1108(ra) # 5996 <printf>
}
    ...
    4e36:	e5650513          	addi	a0,a0,-426 # 7c88 <malloc+0x2234>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	b5c080e7          	jalr	-1188(ra) # 5996 <printf>
    close(fd);
    4e42:	854a                	mv	a0,s2
...
0000000000004e54 <rand>:
{
  ...
  randstate = randstate * 1664525 + 1013904223;
    ...
    4e5e:	42670713          	addi	a4,a4,1062 # 8280 <randstate>
    4e62:	6308                	ld	a0,0(a4)
    4e64:	001967b7          	lui	a5,0x196
    4e68:	60d78793          	addi	a5,a5,1549 # 19660d <__BSS_END__+0x187b55>
    4e6c:	02f50533          	mul	a0,a0,a5
    4e70:	3c6ef7b7          	lui	a5,0x3c6ef
    4e74:	35f78793          	addi	a5,a5,863 # 3c6ef35f <__BSS_END__+0x3c6e08a7>
...
0000000000004e84 <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    4ef8:	dbc50513          	addi	a0,a0,-580 # 7cb0 <malloc+0x225c>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    4f10:	ff458593          	addi	a1,a1,-12 # 5f00 <malloc+0x4ac>
    ...
    4f26:	dae50513          	addi	a0,a0,-594 # 7cd0 <malloc+0x227c>
    4f2a:	00001097          	auipc	ra,0x1
    4f2e:	a6c080e7          	jalr	-1428(ra) # 5996 <printf>
    exit(1);
    4f32:	4505                	li	a0,1
    ...
    4f40:	d7c50513          	addi	a0,a0,-644 # 7cb8 <malloc+0x2264>
    4f44:	00001097          	auipc	ra,0x1
    4f48:	a52080e7          	jalr	-1454(ra) # 5996 <printf>
      exit(1);
    4f4c:	4505                	li	a0,1
    ...
    4f5a:	d6250513          	addi	a0,a0,-670 # 7cb8 <malloc+0x2264>
    4f5e:	00001097          	auipc	ra,0x1
    4f62:	a38080e7          	jalr	-1480(ra) # 5996 <printf>
    exit(1);
    4f66:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    4f7e:	d3650513          	addi	a0,a0,-714 # 7cb0 <malloc+0x225c>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    4fd4:	f3090913          	addi	s2,s2,-208 # 5f00 <malloc+0x4ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    5008:	d1c50513          	addi	a0,a0,-740 # 7d20 <malloc+0x22cc>
    500c:	00001097          	auipc	ra,0x1
    5010:	98a080e7          	jalr	-1654(ra) # 5996 <printf>
        exit(1);
    5014:	4505                	li	a0,1
    ...
    5022:	cc250513          	addi	a0,a0,-830 # 7ce0 <malloc+0x228c>
    5026:	00001097          	auipc	ra,0x1
    502a:	970080e7          	jalr	-1680(ra) # 5996 <printf>
    exit(1);
    502e:	4505                	li	a0,1
    ...
    503c:	cc850513          	addi	a0,a0,-824 # 7d00 <malloc+0x22ac>
    5040:	00001097          	auipc	ra,0x1
    5044:	956080e7          	jalr	-1706(ra) # 5996 <printf>
    exit(1);
    5048:	4505                	li	a0,1
  ...
  while(1){
    ...
    508a:	cba50513          	addi	a0,a0,-838 # 7d40 <malloc+0x22ec>
    508e:	00001097          	auipc	ra,0x1
    5092:	908080e7          	jalr	-1784(ra) # 5996 <printf>
      exit(1);
    5096:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    50da:	c8a50513          	addi	a0,a0,-886 # 7d60 <malloc+0x230c>
    50de:	00001097          	auipc	ra,0x1
    50e2:	8b8080e7          	jalr	-1864(ra) # 5996 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    510a:	c8250513          	addi	a0,a0,-894 # 7d88 <malloc+0x2334>
    510e:	00001097          	auipc	ra,0x1
    5112:	888080e7          	jalr	-1912(ra) # 5996 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    512e:	c4650513          	addi	a0,a0,-954 # 7d70 <malloc+0x231c>
    5132:	00001097          	auipc	ra,0x1
    5136:	864080e7          	jalr	-1948(ra) # 5996 <printf>
    exit(1);
    513a:	4505                	li	a0,1
    ...
    5156:	c3e50513          	addi	a0,a0,-962 # 7d90 <malloc+0x233c>
    515a:	00001097          	auipc	ra,0x1
    515e:	83c080e7          	jalr	-1988(ra) # 5996 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    519e:	d0e78793          	addi	a5,a5,-754 # 7ea8 <malloc+0x2454>
    51a2:	c1040713          	addi	a4,s0,-1008
    51a6:	00003817          	auipc	a6,0x3
    51aa:	0a280813          	addi	a6,a6,162 # 8248 <malloc+0x27f4>
  ...
  printf("usertests starting\n");
    ...
    51d6:	c7650513          	addi	a0,a0,-906 # 7e48 <malloc+0x23f4>
    51da:	00000097          	auipc	ra,0x0
    51de:	7bc080e7          	jalr	1980(ra) # 5996 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    520e:	bf650513          	addi	a0,a0,-1034 # 7e00 <malloc+0x23ac>
    5212:	00000097          	auipc	ra,0x0
    5216:	784080e7          	jalr	1924(ra) # 5996 <printf>
    exit(1);
    521a:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    522a:	b7258593          	addi	a1,a1,-1166 # 7d98 <malloc+0x2344>
    ...
    5240:	c4458593          	addi	a1,a1,-956 # 7e80 <malloc+0x242c>
    ...
    5264:	b4050513          	addi	a0,a0,-1216 # 7da0 <malloc+0x234c>
    5268:	00000097          	auipc	ra,0x0
    526c:	72e080e7          	jalr	1838(ra) # 5996 <printf>
    exit(1);
    5270:	4505                	li	a0,1
    ...
    528e:	70c080e7          	jalr	1804(ra) # 5996 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    52d0:	b1c50513          	addi	a0,a0,-1252 # 7de8 <malloc+0x2394>
    52d4:	00000097          	auipc	ra,0x0
    52d8:	6c2080e7          	jalr	1730(ra) # 5996 <printf>
    exit(1);
    52dc:	4505                	li	a0,1
    ...
    52ea:	b4a50513          	addi	a0,a0,-1206 # 7e30 <malloc+0x23dc>
    52ee:	00000097          	auipc	ra,0x0
    52f2:	6a8080e7          	jalr	1704(ra) # 5996 <printf>
    exit(0);
    52f6:	4501                	li	a0,0
    ...
    5306:	694080e7          	jalr	1684(ra) # 5996 <printf>
        if(continuous != 2)
    ...
    5348:	b6478793          	addi	a5,a5,-1180 # 7ea8 <malloc+0x2454>
    534c:	c1040713          	addi	a4,s0,-1008
    5350:	00003817          	auipc	a6,0x3
    5354:	ef880813          	addi	a6,a6,-264 # 8248 <malloc+0x27f4>
    ...
    5380:	ae450513          	addi	a0,a0,-1308 # 7e60 <malloc+0x240c>
    5384:	00000097          	auipc	ra,0x0
    5388:	612080e7          	jalr	1554(ra) # 5996 <printf>
        printf("SOME TESTS FAILED\n");
    538c:	00003a97          	auipc	s5,0x3
    5390:	a5ca8a93          	addi	s5,s5,-1444 # 7de8 <malloc+0x2394>
        if(continuous != 2)
    5394:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    5396:	00003b17          	auipc	s6,0x3
    539a:	a32b0b13          	addi	s6,s6,-1486 # 7dc8 <malloc+0x2374>
...
putc(int fd, char c)
{
    56be:	1101                	addi	sp,sp,-32
    56c0:	ec06                	sd	ra,24(sp)
    56c2:	e822                	sd	s0,16(sp)
    56c4:	1000                	addi	s0,sp,32
    56c6:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    56ca:	4605                	li	a2,1
    56cc:	fef40593          	addi	a1,s0,-17
    56d0:	00000097          	auipc	ra,0x0
    56d4:	f66080e7          	jalr	-154(ra) # 5636 <write>
}
    56d8:	60e2                	ld	ra,24(sp)
    56da:	6442                	ld	s0,16(sp)
    56dc:	6105                	addi	sp,sp,32
    56de:	8082                	ret

00000000000056e0 <printint>:
...
printint(int fd, int xx, int base, int sgn)
{
    ...
    56e6:	f426                	sd	s1,40(sp)
    56e8:	f04a                	sd	s2,32(sp)
    56ea:	ec4e                	sd	s3,24(sp)
    56ec:	0080                	addi	s0,sp,64
    56ee:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    56f0:	c299                	beqz	a3,56f6 <printint+0x16>
    56f2:	0805c863          	bltz	a1,5782 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    56f6:	2581                	sext.w	a1,a1
  neg = 0;
    56f8:	4881                	li	a7,0
    56fa:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    5700:	2601                	sext.w	a2,a2
    5702:	00003517          	auipc	a0,0x3
    5706:	b5e50513          	addi	a0,a0,-1186 # 8260 <digits>
    570a:	883a                	mv	a6,a4
    570c:	2705                	addiw	a4,a4,1
    570e:	02c5f7bb          	remuw	a5,a1,a2
    5712:	1782                	slli	a5,a5,0x20
    5714:	9381                	srli	a5,a5,0x20
    5716:	97aa                	add	a5,a5,a0
    5718:	0007c783          	lbu	a5,0(a5)
    571c:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    5720:	0005879b          	sext.w	a5,a1
    5724:	02c5d5bb          	divuw	a1,a1,a2
    5728:	0685                	addi	a3,a3,1
    572a:	fec7f0e3          	bgeu	a5,a2,570a <printint+0x2a>
  if(neg)
    572e:	00088b63          	beqz	a7,5744 <printint+0x64>
    buf[i++] = '-';
    5732:	fd040793          	addi	a5,s0,-48
    5736:	973e                	add	a4,a4,a5
    5738:	02d00793          	li	a5,45
    573c:	fef70823          	sb	a5,-16(a4)
    5740:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5744:	02e05863          	blez	a4,5774 <printint+0x94>
    5748:	fc040793          	addi	a5,s0,-64
    574c:	00e78933          	add	s2,a5,a4
    5750:	fff78993          	addi	s3,a5,-1
    5754:	99ba                	add	s3,s3,a4
    5756:	377d                	addiw	a4,a4,-1
    5758:	1702                	slli	a4,a4,0x20
    575a:	9301                	srli	a4,a4,0x20
    575c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5760:	fff94583          	lbu	a1,-1(s2)
    5764:	8526                	mv	a0,s1
    5766:	00000097          	auipc	ra,0x0
    576a:	f58080e7          	jalr	-168(ra) # 56be <putc>
  while(--i >= 0)
    576e:	197d                	addi	s2,s2,-1
    5770:	ff3918e3          	bne	s2,s3,5760 <printint+0x80>
}
    ...
    5780:	8082                	ret
    x = -xx;
    5782:	40b005bb          	negw	a1,a1
    neg = 1;
    5786:	4885                	li	a7,1
    x = -xx;
    5788:	bf8d                	j	56fa <printint+0x1a>

000000000000578a <vprintf>:
}
...
{
    578a:	7119                	addi	sp,sp,-128
    578c:	fc86                	sd	ra,120(sp)
    578e:	f8a2                	sd	s0,112(sp)
    5790:	f4a6                	sd	s1,104(sp)
    5792:	f0ca                	sd	s2,96(sp)
    5794:	ecce                	sd	s3,88(sp)
    5796:	e8d2                	sd	s4,80(sp)
    5798:	e4d6                	sd	s5,72(sp)
    579a:	e0da                	sd	s6,64(sp)
    579c:	fc5e                	sd	s7,56(sp)
    579e:	f862                	sd	s8,48(sp)
    57a0:	f466                	sd	s9,40(sp)
    57a2:	f06a                	sd	s10,32(sp)
    57a4:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    57a8:	0005c903          	lbu	s2,0(a1)
    57ac:	18090f63          	beqz	s2,594a <vprintf+0x1c0>
    57b0:	8aaa                	mv	s5,a0
    57b2:	8b32                	mv	s6,a2
    57b4:	00158493          	addi	s1,a1,1
  state = 0;
    57b8:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    57ba:	02500a13          	li	s4,37
      if(c == 'd'){
    57be:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    57c2:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    57c6:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    57ca:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    57ce:	00003b97          	auipc	s7,0x3
    57d2:	a92b8b93          	addi	s7,s7,-1390 # 8260 <digits>
    57d6:	a839                	j	57f4 <vprintf+0x6a>
        putc(fd, c);
    57d8:	85ca                	mv	a1,s2
    57da:	8556                	mv	a0,s5
    57dc:	00000097          	auipc	ra,0x0
    57e0:	ee2080e7          	jalr	-286(ra) # 56be <putc>
    57e4:	a019                	j	57ea <vprintf+0x60>
    } else if(state == '%'){
    57e6:	01498f63          	beq	s3,s4,5804 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    57ea:	0485                	addi	s1,s1,1
    57ec:	fff4c903          	lbu	s2,-1(s1)
    57f0:	14090d63          	beqz	s2,594a <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    57f4:	0009079b          	sext.w	a5,s2
    if(state == 0){
    57f8:	fe0997e3          	bnez	s3,57e6 <vprintf+0x5c>
      if(c == '%'){
    57fc:	fd479ee3          	bne	a5,s4,57d8 <vprintf+0x4e>
        state = '%';
    5800:	89be                	mv	s3,a5
    5802:	b7e5                	j	57ea <vprintf+0x60>
      if(c == 'd'){
    5804:	05878063          	beq	a5,s8,5844 <vprintf+0xba>
      } else if(c == 'l') {
    5808:	05978c63          	beq	a5,s9,5860 <vprintf+0xd6>
      } else if(c == 'x') {
    580c:	07a78863          	beq	a5,s10,587c <vprintf+0xf2>
      } else if(c == 'p') {
    5810:	09b78463          	beq	a5,s11,5898 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5814:	07300713          	li	a4,115
    5818:	0ce78663          	beq	a5,a4,58e4 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    581c:	06300713          	li	a4,99
    5820:	0ee78e63          	beq	a5,a4,591c <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5824:	11478863          	beq	a5,s4,5934 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5830:	e92080e7          	jalr	-366(ra) # 56be <putc>
        putc(fd, c);
    5834:	85ca                	mv	a1,s2
    5836:	8556                	mv	a0,s5
    5838:	00000097          	auipc	ra,0x0
    583c:	e86080e7          	jalr	-378(ra) # 56be <putc>
      }
      state = 0;
    5840:	4981                	li	s3,0
    5842:	b765                	j	57ea <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    5844:	008b0913          	addi	s2,s6,8
    5848:	4685                	li	a3,1
    584a:	4629                	li	a2,10
    584c:	000b2583          	lw	a1,0(s6)
    5850:	8556                	mv	a0,s5
    5852:	00000097          	auipc	ra,0x0
    5856:	e8e080e7          	jalr	-370(ra) # 56e0 <printint>
    585a:	8b4a                	mv	s6,s2
      state = 0;
    585c:	4981                	li	s3,0
    585e:	b771                	j	57ea <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5860:	008b0913          	addi	s2,s6,8
    5864:	4681                	li	a3,0
    5866:	4629                	li	a2,10
    5868:	000b2583          	lw	a1,0(s6)
    586c:	8556                	mv	a0,s5
    586e:	00000097          	auipc	ra,0x0
    5872:	e72080e7          	jalr	-398(ra) # 56e0 <printint>
    5876:	8b4a                	mv	s6,s2
      state = 0;
    5878:	4981                	li	s3,0
    587a:	bf85                	j	57ea <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    587c:	008b0913          	addi	s2,s6,8
    5880:	4681                	li	a3,0
    5882:	4641                	li	a2,16
    5884:	000b2583          	lw	a1,0(s6)
    5888:	8556                	mv	a0,s5
    588a:	00000097          	auipc	ra,0x0
    588e:	e56080e7          	jalr	-426(ra) # 56e0 <printint>
    5892:	8b4a                	mv	s6,s2
      state = 0;
    5894:	4981                	li	s3,0
    5896:	bf91                	j	57ea <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5898:	008b0793          	addi	a5,s6,8
    589c:	f8f43423          	sd	a5,-120(s0)
    58a0:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    58a4:	03000593          	li	a1,48
    58a8:	8556                	mv	a0,s5
    58aa:	00000097          	auipc	ra,0x0
    58ae:	e14080e7          	jalr	-492(ra) # 56be <putc>
  putc(fd, 'x');
    58b2:	85ea                	mv	a1,s10
    58b4:	8556                	mv	a0,s5
    58b6:	00000097          	auipc	ra,0x0
    58ba:	e08080e7          	jalr	-504(ra) # 56be <putc>
    58be:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    58c0:	03c9d793          	srli	a5,s3,0x3c
    58c4:	97de                	add	a5,a5,s7
    58c6:	0007c583          	lbu	a1,0(a5)
    58ca:	8556                	mv	a0,s5
    58cc:	00000097          	auipc	ra,0x0
    58d0:	df2080e7          	jalr	-526(ra) # 56be <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    58d4:	0992                	slli	s3,s3,0x4
    58d6:	397d                	addiw	s2,s2,-1
    58d8:	fe0914e3          	bnez	s2,58c0 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    58dc:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    58e0:	4981                	li	s3,0
    58e2:	b721                	j	57ea <vprintf+0x60>
        s = va_arg(ap, char*);
    58e4:	008b0993          	addi	s3,s6,8
    58e8:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    58ec:	02090163          	beqz	s2,590e <vprintf+0x184>
        while(*s != 0){
    58f0:	00094583          	lbu	a1,0(s2)
    58f4:	c9a1                	beqz	a1,5944 <vprintf+0x1ba>
          putc(fd, *s);
    58f6:	8556                	mv	a0,s5
    58f8:	00000097          	auipc	ra,0x0
    58fc:	dc6080e7          	jalr	-570(ra) # 56be <putc>
          s++;
    5900:	0905                	addi	s2,s2,1
        while(*s != 0){
    5902:	00094583          	lbu	a1,0(s2)
    5906:	f9e5                	bnez	a1,58f6 <vprintf+0x16c>
        s = va_arg(ap, char*);
    5908:	8b4e                	mv	s6,s3
      state = 0;
    590a:	4981                	li	s3,0
    590c:	bdf9                	j	57ea <vprintf+0x60>
          s = "(null)";
    590e:	00003917          	auipc	s2,0x3
    5912:	94a90913          	addi	s2,s2,-1718 # 8258 <malloc+0x2804>
        while(*s != 0){
    5916:	02800593          	li	a1,40
    591a:	bff1                	j	58f6 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    591c:	008b0913          	addi	s2,s6,8
    5920:	000b4583          	lbu	a1,0(s6)
    5924:	8556                	mv	a0,s5
    5926:	00000097          	auipc	ra,0x0
    592a:	d98080e7          	jalr	-616(ra) # 56be <putc>
    592e:	8b4a                	mv	s6,s2
      state = 0;
    5930:	4981                	li	s3,0
    5932:	bd65                	j	57ea <vprintf+0x60>
        putc(fd, c);
    5934:	85d2                	mv	a1,s4
    5936:	8556                	mv	a0,s5
    5938:	00000097          	auipc	ra,0x0
    593c:	d86080e7          	jalr	-634(ra) # 56be <putc>
      state = 0;
    5940:	4981                	li	s3,0
    5942:	b565                	j	57ea <vprintf+0x60>
        s = va_arg(ap, char*);
    5944:	8b4e                	mv	s6,s3
      state = 0;
    5946:	4981                	li	s3,0
    5948:	b54d                	j	57ea <vprintf+0x60>
    }
  }
}
    594a:	70e6                	ld	ra,120(sp)
    594c:	7446                	ld	s0,112(sp)
    594e:	74a6                	ld	s1,104(sp)
    5950:	7906                	ld	s2,96(sp)
    5952:	69e6                	ld	s3,88(sp)
    5954:	6a46                	ld	s4,80(sp)
    5956:	6aa6                	ld	s5,72(sp)
    5958:	6b06                	ld	s6,64(sp)
    595a:	7be2                	ld	s7,56(sp)
    595c:	7c42                	ld	s8,48(sp)
    595e:	7ca2                	ld	s9,40(sp)
    5960:	7d02                	ld	s10,32(sp)
    5962:	6de2                	ld	s11,24(sp)
    5964:	6109                	addi	sp,sp,128
    5966:	8082                	ret

0000000000005968 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5968:	715d                	addi	sp,sp,-80
    596a:	ec06                	sd	ra,24(sp)
    596c:	e822                	sd	s0,16(sp)
    596e:	1000                	addi	s0,sp,32
    5970:	e010                	sd	a2,0(s0)
    5972:	e414                	sd	a3,8(s0)
    5974:	e818                	sd	a4,16(s0)
    5976:	ec1c                	sd	a5,24(s0)
    5978:	03043023          	sd	a6,32(s0)
    597c:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5980:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5984:	8622                	mv	a2,s0
    5986:	00000097          	auipc	ra,0x0
    598a:	e04080e7          	jalr	-508(ra) # 578a <vprintf>
}
    598e:	60e2                	ld	ra,24(sp)
    5990:	6442                	ld	s0,16(sp)
    5992:	6161                	addi	sp,sp,80
    5994:	8082                	ret

0000000000005996 <printf>:

void
printf(const char *fmt, ...)
{
    5996:	711d                	addi	sp,sp,-96
    5998:	ec06                	sd	ra,24(sp)
    599a:	e822                	sd	s0,16(sp)
    599c:	1000                	addi	s0,sp,32
    599e:	e40c                	sd	a1,8(s0)
    59a0:	e810                	sd	a2,16(s0)
    59a2:	ec14                	sd	a3,24(s0)
    59a4:	f018                	sd	a4,32(s0)
    59a6:	f41c                	sd	a5,40(s0)
    59a8:	03043823          	sd	a6,48(s0)
    59ac:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    59b0:	00840613          	addi	a2,s0,8
    59b4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    59b8:	85aa                	mv	a1,a0
    59ba:	4505                	li	a0,1
    59bc:	00000097          	auipc	ra,0x0
    59c0:	dce080e7          	jalr	-562(ra) # 578a <vprintf>
}
    59c4:	60e2                	ld	ra,24(sp)
    59c6:	6442                	ld	s0,16(sp)
    59c8:	6125                	addi	sp,sp,96
    59ca:	8082                	ret

00000000000059cc <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    59d2:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    59d6:	00003797          	auipc	a5,0x3
    59da:	8b27b783          	ld	a5,-1870(a5) # 8288 <freep>
    59de:	a805                	j	5a0e <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    59e0:	4618                	lw	a4,8(a2)
    59e2:	9db9                	addw	a1,a1,a4
    59e4:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    59e8:	6398                	ld	a4,0(a5)
    59ea:	6318                	ld	a4,0(a4)
    59ec:	fee53823          	sd	a4,-16(a0)
    59f0:	a091                	j	5a34 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    59f2:	ff852703          	lw	a4,-8(a0)
    59f6:	9e39                	addw	a2,a2,a4
    59f8:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    59fa:	ff053703          	ld	a4,-16(a0)
    59fe:	e398                	sd	a4,0(a5)
    5a00:	a099                	j	5a46 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5a02:	6398                	ld	a4,0(a5)
    5a04:	00e7e463          	bltu	a5,a4,5a0c <free+0x40>
    5a08:	00e6ea63          	bltu	a3,a4,5a1c <free+0x50>
{
    5a0c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5a0e:	fed7fae3          	bgeu	a5,a3,5a02 <free+0x36>
    5a12:	6398                	ld	a4,0(a5)
    5a14:	00e6e463          	bltu	a3,a4,5a1c <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5a18:	fee7eae3          	bltu	a5,a4,5a0c <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5a1c:	ff852583          	lw	a1,-8(a0)
    5a20:	6390                	ld	a2,0(a5)
    5a22:	02059713          	slli	a4,a1,0x20
    5a26:	9301                	srli	a4,a4,0x20
    5a28:	0712                	slli	a4,a4,0x4
    5a2a:	9736                	add	a4,a4,a3
    5a2c:	fae60ae3          	beq	a2,a4,59e0 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5a30:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5a34:	4790                	lw	a2,8(a5)
    5a36:	02061713          	slli	a4,a2,0x20
    5a3a:	9301                	srli	a4,a4,0x20
    5a3c:	0712                	slli	a4,a4,0x4
    5a3e:	973e                	add	a4,a4,a5
    5a40:	fae689e3          	beq	a3,a4,59f2 <free+0x26>
  } else
    p->s.ptr = bp;
    5a44:	e394                	sd	a3,0(a5)
  freep = p;
    5a46:	00003717          	auipc	a4,0x3
    5a4a:	84f73123          	sd	a5,-1982(a4) # 8288 <freep>
}
    5a4e:	6422                	ld	s0,8(sp)
    5a50:	0141                	addi	sp,sp,16
    5a52:	8082                	ret

0000000000005a54 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5a54:	7139                	addi	sp,sp,-64
    5a56:	fc06                	sd	ra,56(sp)
    5a58:	f822                	sd	s0,48(sp)
    5a5a:	f426                	sd	s1,40(sp)
    5a5c:	f04a                	sd	s2,32(sp)
    5a5e:	ec4e                	sd	s3,24(sp)
    5a60:	e852                	sd	s4,16(sp)
    5a62:	e456                	sd	s5,8(sp)
    5a64:	e05a                	sd	s6,0(sp)
    5a66:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5a68:	02051493          	slli	s1,a0,0x20
    5a6c:	9081                	srli	s1,s1,0x20
    5a6e:	04bd                	addi	s1,s1,15
    5a70:	8091                	srli	s1,s1,0x4
    5a72:	0014899b          	addiw	s3,s1,1
    5a76:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5a78:	00003517          	auipc	a0,0x3
    5a7c:	81053503          	ld	a0,-2032(a0) # 8288 <freep>
    5a80:	c515                	beqz	a0,5aac <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5a82:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5a84:	4798                	lw	a4,8(a5)
    5a86:	02977f63          	bgeu	a4,s1,5ac4 <malloc+0x70>
    5a8a:	8a4e                	mv	s4,s3
    5a8c:	0009871b          	sext.w	a4,s3
    5a90:	6685                	lui	a3,0x1
    5a92:	00d77363          	bgeu	a4,a3,5a98 <malloc+0x44>
    5a96:	6a05                	lui	s4,0x1
    5a98:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5a9c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5aa0:	00002917          	auipc	s2,0x2
    5aa4:	7e890913          	addi	s2,s2,2024 # 8288 <freep>
  if(p == (char*)-1)
    5aa8:	5afd                	li	s5,-1
    5aaa:	a88d                	j	5b1c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5aac:	00009797          	auipc	a5,0x9
    5ab0:	ffc78793          	addi	a5,a5,-4 # eaa8 <base>
    5ab4:	00002717          	auipc	a4,0x2
    5ab8:	7cf73a23          	sd	a5,2004(a4) # 8288 <freep>
    5abc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5abe:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5ac2:	b7e1                	j	5a8a <malloc+0x36>
      if(p->s.size == nunits)
    5ac4:	02e48b63          	beq	s1,a4,5afa <malloc+0xa6>
        p->s.size -= nunits;
    5ac8:	4137073b          	subw	a4,a4,s3
    5acc:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5ace:	1702                	slli	a4,a4,0x20
    5ad0:	9301                	srli	a4,a4,0x20
    5ad2:	0712                	slli	a4,a4,0x4
    5ad4:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5ad6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5ada:	00002717          	auipc	a4,0x2
    5ade:	7aa73723          	sd	a0,1966(a4) # 8288 <freep>
      return (void*)(p + 1);
    5ae2:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5ae6:	70e2                	ld	ra,56(sp)
    5ae8:	7442                	ld	s0,48(sp)
    5aea:	74a2                	ld	s1,40(sp)
    5aec:	7902                	ld	s2,32(sp)
    5aee:	69e2                	ld	s3,24(sp)
    5af0:	6a42                	ld	s4,16(sp)
    5af2:	6aa2                	ld	s5,8(sp)
    5af4:	6b02                	ld	s6,0(sp)
    5af6:	6121                	addi	sp,sp,64
    5af8:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5afa:	6398                	ld	a4,0(a5)
    5afc:	e118                	sd	a4,0(a0)
    5afe:	bff1                	j	5ada <malloc+0x86>
  hp->s.size = nu;
    5b00:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5b04:	0541                	addi	a0,a0,16
    5b06:	00000097          	auipc	ra,0x0
    5b0a:	ec6080e7          	jalr	-314(ra) # 59cc <free>
  return freep;
    5b0e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5b12:	d971                	beqz	a0,5ae6 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5b14:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5b16:	4798                	lw	a4,8(a5)
    5b18:	fa9776e3          	bgeu	a4,s1,5ac4 <malloc+0x70>
    if(p == freep)
    5b1c:	00093703          	ld	a4,0(s2)
    5b20:	853e                	mv	a0,a5
    5b22:	fef719e3          	bne	a4,a5,5b14 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5b26:	8552                	mv	a0,s4
    5b28:	00000097          	auipc	ra,0x0
    5b2c:	b76080e7          	jalr	-1162(ra) # 569e <sbrk>
  if(p == (char*)-1)
    5b30:	fd5518e3          	bne	a0,s5,5b00 <malloc+0xac>
        return 0;
    5b34:	4501                	li	a0,0
    5b36:	bf45                	j	5ae6 <malloc+0x92>
